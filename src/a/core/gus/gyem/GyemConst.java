...
public class GyemConst {
	...
	public static final Class M009_G_CONFIG_PARAM =				a.core.gus.gyem.m009.g.config.param.Module.class;
	public static final Class M010_T_READ_PROP =				a.core.gus.gyem.m010.t.read.prop.Module.class;
	public static final Class M011_T_READ_INPUTSTREAM =			a.core.gus.gyem.m011.t.read.inputstream.Module.class;
	public static final Class M012_T_MODULE_BUILD =				a.core.gus.gyem.m012.t.module.build.Module.class;
	public static final Class M013_G_SERVICE_BUILD_EMPTY =		a.core.gus.gyem.m013.g.service.build.empty.Module.class;
	public static final Class M014_T_ENTITY_PROVIDE =			a.core.gus.gyem.m014.t.entity.provide.Module.class;
	public static final Class M015_T_ENTITY_UNIQUE =			a.core.gus.gyem.m015.t.entity.unique.Module.class;
	public static final Class M016_T_ENTITY_GENERATE =			a.core.gus.gyem.m016.t.entity.generate.Module.class;
	public static final Class M017_T_ENTITY_FINDCLASS =			a.core.gus.gyem.m017.t.entity.findclass.Module.class;
	public static final Class M018_T_ENTITY_LOADCLASS =			a.core.gus.gyem.m018.t.entity.loadclass.Module.class;
	public static final Class M019_T_ENTITY_NAMETOPATH =		a.core.gus.gyem.m019.t.entity.nametopath.Module.class;
	public static final Class M020_G_ARGS_PARAM =				a.core.gus.gyem.m020.g.args.param.Module.class;
	...
	public static final Class M041_T_ENTITY_FINDNAME = 			a.core.gus.gyem.m042.t.entity.findname.Module.class;
	public static final Class M042_T_RESOURCE_FINDRULE = 		a.core.gus.gyem.m043.t.resource.findrule.Module.class;
	public static final Class M043_T_RESOURCE_FINDRULE1 = 		a.core.gus.gyem.m044.t.resource.findrule1.Module.class;
	public static final Class M044_T_MANAGER_RESOURCE = 		a.core.gus.gyem.m037.t.manager.resource.Module.class;
