package a.entity.gus.x.socket.wrap1;
...
public class EntityImpl implements Entity, T, V {
	...
	//passer le charset directement dans le t avec le socket (Socket / Object[])
	//supprimer la variable de classe et la caracteristique V
	//refactorer tout le code appelant
	
	//TODO ameliorations possibles :
	//separation stricte
	//SocketTransport (IO pur)
	//ConnectionState (etat)
	//ProtocolHandler (END etc)
	...
	public class Holder extends S1 implements R, V, P, G, Runnable
	{
		...
		private PrintWriter out;//FIXME : error not handled
		...
		public void run()
		{
			...
			listeners().clear(); //TODO : dangereux ?
		}
