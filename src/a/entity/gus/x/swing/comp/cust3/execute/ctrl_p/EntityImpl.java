package a.entity.gus.x.swing.comp.cust3.execute.ctrl_p;
...
public class EntityImpl implements Entity, P {
	...
	public String creationDate() {return "20231208";}
	...
	private class Holder implements KeyListener, MouseListener
	{
		...
		{if(evt.isControlDown() && evt.getKeyCode()==KeyEvent.VK_P) execute(ex);}
