package a.entity.gus.y.appview1.entryview;
...
public class EntityImpl implements Entity, P, I {
	...
	public EntityImpl() throws Exception {
		handleInputStream = Outside.service(this, "gus.y.appview1.handle.entryinputstream");
		entryViewPanel = Outside.service(this, "*gus.y.appview1.entryview.panel");
		pathToIcon = Outside.service(this, "gus.y.files1.icon.name");
	...
	private Icon icon(Object obj) {
		try {
			return (Icon) pathToIcon.t(obj);
		} catch (Exception e) {
			Outside.err(this, "icon(Object)", e);
		}
		return null;
	}
}
