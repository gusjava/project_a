package a.entity.gus.y.appview1.entryview.panel.class1;
...
public class EntityImpl implements Entity, P, I {
	...
	public EntityImpl() throws Exception {
		formPanel = Outside.service(this, "*gus.y.swing1.panel.formpanel.string");
		jdkMapping = Outside.service(this, "gus.x.java.jdk.versionmapping");
		analyze = Outside.service(this, "gus.y.api1.jdepend.analyze.data");
		setToString = Outside.service(this, "gus.y.tostring1.set");
