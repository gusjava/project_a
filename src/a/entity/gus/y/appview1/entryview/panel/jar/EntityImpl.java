package a.entity.gus.y.appview1.entryview.panel.jar;
...
public class EntityImpl implements Entity, P, I {
	...
	public EntityImpl() throws Exception {
		buildEntries = Outside.service(this, "gus.x.io.jar.build.entries");
		listToString = Outside.service(this, "gus.x.tostring.list");
