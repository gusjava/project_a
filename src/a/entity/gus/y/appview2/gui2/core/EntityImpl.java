package a.entity.gus.y.appview2.gui2.core;
...
public class EntityImpl implements Entity, P, I, ListSelectionListener {
	...
	public EntityImpl() throws Exception {
		...
		coreViewer = Outside.service(this, "*gus.y.appview2.gui2.core.detail");
	...
	private String findCoreName(String path) throws Exception {
		...
		if (nn.length < 3)
			throw new Exception("Invalid class path for core component: " + path);
		return nn[0] + "." + nn[1];
	}
