package a.entity.gus.y.appview2.gui3.entity.detail;
...
public class EntityImpl implements Entity, P, I {
	...
	public EntityImpl() throws Exception {
		...
		panelMany = Outside.service(this, "*gus.y.appview2.gui3.entity.detail.many");
		srcViewer = Outside.service(this, "*gus.y.appview1.entryview");
	}
