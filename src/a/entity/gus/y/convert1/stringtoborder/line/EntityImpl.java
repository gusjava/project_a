package a.entity.gus.y.convert1.stringtoborder.line;
...
public class EntityImpl implements Entity, T {
	...
	private Border build(String rule) throws Exception {
		...
		if (n.length == 1)
			return BorderFactory.createLineBorder(color(n[0]));
		if (n.length == 2)
			return BorderFactory.createLineBorder(color(n[0]), int_(n[1]));
