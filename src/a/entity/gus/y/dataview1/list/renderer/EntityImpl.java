package a.entity.gus.y.dataview1.list.renderer;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		desc = Outside.service(this, "gus.y.tostring1.desc.short1");
	}

	private String desc(Object obj) {
		try {
			return (String) desc.t(obj);
		} catch (Exception e) {
			Outside.err(this, "desc(Object)", e);
		}
		return "###ERR###";
	}
