package a.entity.gus.y.dataview1.map.main.uniqueentity;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception {
		...
		renderer = Outside.service(this, "gus.x.swing.list.cust.renderer.icon");
		map = (Map) Outside.resource(this, "uniqueentitymap");
