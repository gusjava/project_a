package a.entity.gus.y.dataview1.object;
...
public class EntityImpl implements Entity, G, P, I {
	...
	public EntityImpl() throws Exception {
		builder = Outside.service(this, "gus.y.dataview1.object.builder");
		infoViewer = Outside.service(this, "*gus.y.dataview1.object.panel.info");
		classViewer = Outside.service(this, "*gus.y.dataview1.object.panel.class1");
