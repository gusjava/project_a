package a.entity.gus.y.desktop1.action.item.remove;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "SWING_JFrame_remove#Remove selected item";
	...
	{
		handler = Outside.service(this,"gus.y.desktop1.execute.item.remove");
		buildAction = Outside.service(this,"gus06.swing.action.builder1");
		wrap = Outside.service(this,"gus06.feature.wrap.po.e");
		enabler = Outside.service(this,"gus.y.desktop1.action.item.remove.enabler");
	}
