package a.entity.gus.y.desktop1.gui.maingui;
...
public class EntityImpl implements Entity, I, P {
	...
	public EntityImpl() throws Exception
	{
		...
		buildMain = Outside.service(this,"gus.y.desktop1.data.main.build");
		custPane = Outside.service(this,"gus.y.desktop1.gui.pane.cust");
		custBar = Outside.service(this,"gus.y.desktop1.gui.bar.cust");
		buildBar = Outside.service(this,"gus06.swing.toolbar.toolbar1");
		loadAll = Outside.service(this,"gus.y.desktop1.item.manager.load");
