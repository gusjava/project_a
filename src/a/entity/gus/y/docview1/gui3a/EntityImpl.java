package a.entity.gus.y.docview1.gui3a;
...
public class EntityImpl implements Entity, P, I, V, ListSelectionListener {
	...
	public EntityImpl() throws Exception {
		gui1 = Outside.service(this, "*gus.y.docview1.gui1a");
	...
	public void p(Object obj) throws Exception {
		...
		for(int i=0;i<devList.size();i++) {
			...
			for(int j=0;j<pathsForDev.size();j++) {
				...
				String lastPart = pathToLastPart(path);
				data.add(new String[] {dev+delim+lastPart, path});
			}
		}
