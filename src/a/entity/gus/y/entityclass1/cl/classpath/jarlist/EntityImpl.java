package a.entity.gus.y.entityclass1.cl.classpath.jarlist;
...
public class EntityImpl implements Entity, G {
	...
	public EntityImpl() throws Exception {
		dirToFiles = Outside.service(this, "gus.x.dir.jar.files");
		findJreClassPath = Outside.service(this, "gus.x.jre.prop.classpath.as.filearray");
		getConfig = Outside.service(this, "gus.y.entityclass1.cl.classpath.jarlist.config");
		extractJar = Outside.service(this, "gus.y.entityclass1.cl.classpath.jarlist.extract");
	...
	public Object g() throws Exception {
		...
		for (String n : nn)
			if (!mapJreClasspath.containsKey(n)) {
				if (mapLocalJars.containsKey(n)) {
					...
					extractJar.p(newJar);
					if (!newJar.isFile())
						throw new Exception("Failed to init jar: " + newJar);
					list.add(newJar);
				}
			}
		return list;
