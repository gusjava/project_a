package a.entity.gus.y.entityclass1.cl.classpath.jarlist.config;
...
public class EntityImpl implements Entity, G {
	...
	public EntityImpl() throws Exception {
		loadText = Outside.service(this, "gus.y.config1.load.text");
		getArch = Outside.service(this, "gus.x.jre.prop.arch.datamodel");
	}
