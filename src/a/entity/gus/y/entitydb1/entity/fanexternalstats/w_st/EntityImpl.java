package a.entity.gus.y.entitydb1.entity.fanexternalstats.w_st;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		String sql = "SELECT e.entity_name AS name, (SELECT COUNT(*) FROM entity_link l WHERE l.link = e.entity_name AND l.entity_name NOT LIKE ?) AS fanin FROM entity e WHERE e.entity_name LIKE ?";
