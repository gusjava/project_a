package a.entity.gus.y.entitydb1.entity.findall.importedby.co;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception {
		...
		String sql = "SELECT DISTINCT " + COL_ENTITY_NAME + " FROM " + TABLE_NAME + " WHERE " + COL_ENTITY_IMPORT + " LIKE ? ORDER BY " + COL_ENTITY_NAME;
