package a.entity.gus.y.entitydb1.entity_src_save.update;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception {
		...
		try {
			...
			+ COL_DATE + "=?, " + COL_SRC + "=? WHERE "
			+ COL_ENTITY_NAME + "=? AND " + COL_FILE_NAME + "=?";
			
			executeUpdate(cx, sql, date, src, entityName, fileName);
		} catch (SQLException e) {
			String message = "Failed to update row with entityName=" + entityName + " and fileName=" + fileName;
