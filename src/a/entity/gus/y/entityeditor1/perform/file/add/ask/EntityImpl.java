package a.entity.gus.y.entityeditor1.perform.file.add.ask;
...
public class EntityImpl implements Entity, P, F {
	...
	public EntityImpl() throws Exception {
		perform = Outside.service(this, "gus.y.entityeditor1.perform.file.add");
	}
	...
	public boolean f(Object obj) throws Exception {
		...
		if (className.endsWith(".java"))
			className = className.substring(0, n - 5);
