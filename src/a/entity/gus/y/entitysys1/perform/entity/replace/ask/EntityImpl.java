package a.entity.gus.y.entitysys1.perform.entity.replace.ask;
...
public class EntityImpl implements Entity, P, F {
	...
	public static final String TITLE = "Entity replacement";
	public static final String MESSAGE = "Please, enter entity's replacement name:";
	...
	{
		perform = Outside.service(this, "gus.y.entitysys1.perform.entity.replace");
