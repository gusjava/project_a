package a.entity.gus.y.errors1.gui1;
...
public class EntityImpl implements Entity, I, ActionListener {
	...
	public EntityImpl() throws Exception {
		watcher = Outside.service(this, "gus.y.errors1.watcher");
		exceptionView = Outside.service(this, "*gus.y.dataview1.exception");
	...
	private class TableModel0 extends AbstractTableModel implements Runnable {
		...
		public Object getValueAt(int x, int y) {
			...
			if (y == 0)
				return timeStamp(date); // time stamp
			if (y == 1)
				return sourceName(entity); // source
			if (y == 2)
				return method; // id
			if (y == 3)
