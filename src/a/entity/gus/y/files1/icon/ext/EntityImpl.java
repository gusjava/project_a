package a.entity.gus.y.files1.icon.ext;
...
public class EntityImpl implements Entity, T, R, G {
	...
	public EntityImpl() throws Exception {
		...
		fileSample = Outside.service(this, "gus.y.files1.ext.sample");
		loadIcon = Outside.service(this, "gus.y.icons1.loader");
