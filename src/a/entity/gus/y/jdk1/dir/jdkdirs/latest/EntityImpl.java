package a.entity.gus.y.jdk1.dir.jdkdirs.latest;
...
public class EntityImpl implements Entity, G {
	...
	public EntityImpl() throws Exception {
		jdkDirs = Outside.service(this, "gus.y.jdk1.dir.jdkdirs");
	}
	...
	private void init() throws Exception {
		...
		for (int i = 1; i < dirs.length; i++)
			if (comparator.compare(dirs[i], dir) == 1)
				dir = dirs[i];
	}
	...
	public class JdkComparator implements Comparator {
		public int compare(Object jdk1, Object jdk2) {
			...
			if (jdkVersion1.equals(jdkVersion2))
				return 0;
