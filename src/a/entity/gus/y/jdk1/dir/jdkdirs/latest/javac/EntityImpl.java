package a.entity.gus.y.jdk1.dir.jdkdirs.latest.javac;
...
public class EntityImpl implements Entity, G {
	...
	public EntityImpl() throws Exception {
		getLatest = Outside.service(this, "gus.y.jdk1.dir.jdkdirs.latest");
	}
	...
	private File javacFile(File jdkDir) throws Exception {
		...
		if (!javacExe.isFile())
			throw new Exception("Javac exe not found: " + javacExe);
		return javacExe;
	}
}
