package a.entity.gus.y.knowledgedb1.cx.initdb.note_tag;
...
public class EntityImpl implements Entity, P {
	...
	public static final String DEF_ID_NOTE = "BIGINT NOT NULL";
	public static final String DEF_TAG = "VARCHAR(50) NOT NULL";

	public void p(Object obj) throws Exception {
		Connection cx = (Connection) obj;
		String sql = "CREATE TABLE " + TABLE_NAME + " ("
				+ COL_ID_NOTE + " " + DEF_ID_NOTE + ", "
				+ COL_TAG + " " + DEF_TAG + ", "
				+ "PRIMARY KEY (" + COL_ID_NOTE + ", " + COL_TAG + "))";
		execute(cx, sql);
	}
