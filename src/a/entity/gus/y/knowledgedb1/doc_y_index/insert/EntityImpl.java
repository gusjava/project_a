package a.entity.gus.y.knowledgedb1.doc_y_index.insert;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception {
		...
		String sql = "INSERT INTO " + TABLE_NAME + " ("
				+ COL_DOC_Y_ID + ", " + COL_MEMBER_KEY + ", " + COL_DESCRIPTION + ") VALUES (?,?,?)";
		executeUpdate(cx, sql, docYId, memberKey, description);
	}
