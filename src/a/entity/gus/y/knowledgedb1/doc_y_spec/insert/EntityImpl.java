package a.entity.gus.y.knowledgedb1.doc_y_spec.insert;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception {
		...
		String sql = "INSERT INTO " + TABLE_NAME + " (" + COL_DOC_Y_ID + ", " + COL_SPEC_ID + ") VALUES (?,?)";
		executeUpdate(cx, sql, docYId, specId);
	}
