package a.entity.gus.y.knowledgedb1.todo_knowledge.find2;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception {
		...
		String sql = "SELECT " + COL_ID_TODO + ", " + COL_TYPE + " FROM " + TABLE_NAME
				+ " WHERE " + COL_ID_KNOWLEDGE + "=?";
