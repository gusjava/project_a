...
public class EntityImpl extends S1 implements Entity, E, R {
	...
	private Service findallKnowledgeLinks;
	...
	public EntityImpl() throws Exception
	{
		...
		findallKnowledgeLinks = Outside.service(this, "gus.y.knowledgedb1.knowledge_link.findall");
	...
	private void load()
	{
		try
		{
			...
			knowledgeLinks = (List) findallKnowledgeLinks.t(cx);
	...
	public Object r(String key) throws Exception
	{
		...
		if (key.equals("knowledgeLinks")) return knowledgeLinks;
		...
		if (key.equals("keys")) return new String[]
			{"cx",
			"knowledgeRoots", "knowledgeLeafs", "knowledgeList", "knowledgeTags", "knowledgeLinks",
			"todoRoots", "todoLeafs", "todoList"};
