package a.entity.gus.y.knowledgesys1.gui.gui1_2.knowledge.treeup;
...
public class EntityImpl implements Entity, I, V, ActionListener {
	...
	{
		guiSelector = Outside.service(this, "*gus.y.knowledgesys1.gui.gui1_2.knowledge.treeup.selector");
