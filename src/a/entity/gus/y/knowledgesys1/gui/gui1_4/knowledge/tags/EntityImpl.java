package a.entity.gus.y.knowledgesys1.gui.gui1_4.knowledge.tags;
...
public class EntityImpl implements Entity, I, V, ActionListener
{
	...
	{
		guiSelector = Outside.service(this, "*gus.y.knowledgesys1.gui.gui1_4.knowledge.tags.selector");
		guiDetail = Outside.service(this, "*gus.y.knowledgesys1.gui.gui1_4.knowledge.tags.detail");
