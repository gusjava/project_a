package a.entity.gus.y.knowledgesys1.gui.knowledge.downlink.add;
...
public class EntityImpl implements Entity, P {
	...
	private JTextField fieldLinked = new JTextField();
	...
	public EntityImpl() throws Exception {
		...
		fields.add(new JLabel("Linked code:"));
		fields.add(fieldLinked);
	...
	public void p(Object obj) throws Exception {
		...
		String linkedCode = fieldLinked.getText().trim();
		String type       = fieldType.getText().trim();
		if (linkedCode.isEmpty()) return;
