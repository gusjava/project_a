...
public class EntityImpl implements Entity, I, P {
	...
	public EntityImpl() throws Exception {
		...
		gui1 = Outside.service(this, "*gus.y.knowledgesys1.gui.todo.detail1.gui1.form");
		gui2 = Outside.service(this, "*gus.y.knowledgesys1.gui.todo.detail1.gui2.uplinks");
		gui3 = Outside.service(this, "*gus.y.knowledgesys1.gui.todo.detail1.gui3.downlinks");
		gui4 = Outside.service(this, "*gus.y.knowledgesys1.gui.todo.detail1.gui4.tags");
