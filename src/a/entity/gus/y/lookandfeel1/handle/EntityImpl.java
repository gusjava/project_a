package a.entity.gus.y.lookandfeel1.handle;
...
public class EntityImpl implements Entity, P, V {
	...
	public EntityImpl() throws Exception {
		convertor = Outside.service(this, "gus.y.convert1.stringtoobject.convertor1");
	}
