package a.entity.gus.y.menu1.fr.init;
...
public class EntityImpl implements Entity, E {
	...
	public EntityImpl() throws Exception {
		...
		getActionAbout = Outside.service(this, "gus.y.appli1.fr.action.about");
		getActionExit = Outside.service(this, "gus.y.appli1.fr.action.exit");
	}
