package a.entity.gus.y.persist1.build;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception {
		...
		writeProp = Outside.service(this, "gus.x.file.prop.write");

		dirToSet = Outside.service(this, "gus.y.dirs1.listing0.files.name0");
	}
	...
	private class Holder implements R, V, F, G {
		...
		public Object r(String key) throws Exception {
			...
			if (f1.isFile())
				return readProp.t(f1);

			File f2 = fileTxt(key);
			if (f2.isFile())
				return readString.t(f2);
		...
		public boolean f(Object obj) throws Exception {
			if (fileProp((String) obj).isFile())
				return true;
			if (fileTxt((String) obj).isFile())
				return true;
