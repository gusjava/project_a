package a.entity.gus.y.persist1.main;
...
public class EntityImpl implements Entity, G, F, R, V {
	...
	public EntityImpl() throws Exception {
		changeDetector = Outside.service(this, "*gus.y.changedetect1.check");
		builder = Outside.service(this, "gus.y.persist1.build");
		dir = (File) Outside.resource(this, "path#path.persistencedir");

		if (dir == null)
			throw new Exception("Persistence dir not found");
	...
	public Object r(String key) throws Exception {
		...
		if (value instanceof String)
			changeDetector.p(new String[] { key, (String) value });
		return value;
	}
