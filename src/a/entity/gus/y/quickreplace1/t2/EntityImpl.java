package a.entity.gus.y.quickreplace1.t2;
...
public class EntityImpl implements Entity, T {
	...
	{
		byRegex = Outside.service(this,"gus.y.quickreplace1.t2.byregex");
		byPosition = Outside.service(this,"gus.y.quickreplace1.t2.byposition");
	}
