package a.entity.gus.y.roadmapdb1.cx.main;
...
public class EntityImpl implements Entity, G, ActionListener {
	...
	public static final String DBNAME = "roadmap";
	...
	public EntityImpl() throws Exception {
		...
		initDb = Outside.service(this, "gus.y.roadmapdb1.cx.initdb");
		checkDb = Outside.service(this, "gus.y.h2cache1.check");
		exit = Outside.service(this, "gus.y.cust1.exit");
