package a.entity.gus.y.roadmapsys1.maingui;
...
public class EntityImpl implements Entity, I, ActionListener
{
	...
	{
		guiListing = Outside.service(this, "*gus.y.roadmapsys1.maingui.list");
		guiDetail = Outside.service(this, "*gus.y.roadmapsys1.maingui.detail");
