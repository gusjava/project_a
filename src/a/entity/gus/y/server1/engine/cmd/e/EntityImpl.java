...
public class EntityImpl implements Entity, T {
	...
	private Service fanoutinternalstats_st;
	private Service fanoutinternalstats_en;
	private Service fanoutinternalstats_co;
	private Service fanoutexternalstats_st;
	private Service fanoutexternalstats_en;
	private Service fanoutexternalstats_co;
	private Service internalhubs_st;
	private Service internalhubs_en;
	private Service internalhubs_co;
	private Service internalcomponents_st;
	private Service internalcomponents_en;
	private Service internalcomponents_co;
	...
	public EntityImpl() throws Exception
	{
		...
		fanoutinternalstats_st = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutinternalstats_w_st");
		fanoutinternalstats_en = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutinternalstats_w_en");
		fanoutinternalstats_co = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutinternalstats_w_co");
		fanoutexternalstats_st = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutexternalstats_w_st");
		fanoutexternalstats_en = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutexternalstats_w_en");
		fanoutexternalstats_co = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.fanoutexternalstats_w_co");
		internalhubs_st = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalhubs_w_st");
		internalhubs_en = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalhubs_w_en");
		internalhubs_co = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalhubs_w_co");
		internalcomponents_st = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalcomponents_w_st");
		internalcomponents_en = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalcomponents_w_en");
		internalcomponents_co = Outside.service(this, "gus.y.server1.engine.cmd.e.n1.internalcomponents_w_co");
	...
	private Service findCmd(String cmd) throws Exception
	{
		...
		if(cmd.equals("fanoutinternalstats_st"))  return fanoutinternalstats_st;
		if(cmd.equals("fanoutinternalstats_en"))  return fanoutinternalstats_en;
		if(cmd.equals("fanoutinternalstats_co"))  return fanoutinternalstats_co;
		if(cmd.equals("fanoutexternalstats_st"))  return fanoutexternalstats_st;
		if(cmd.equals("fanoutexternalstats_en"))  return fanoutexternalstats_en;
		if(cmd.equals("fanoutexternalstats_co"))  return fanoutexternalstats_co;
		if(cmd.equals("internalhubs_st"))  return internalhubs_st;
		if(cmd.equals("internalhubs_en"))  return internalhubs_en;
		if(cmd.equals("internalhubs_co"))  return internalhubs_co;
		if(cmd.equals("internalcomponents_st"))  return internalcomponents_st;
		if(cmd.equals("internalcomponents_en"))  return internalcomponents_en;
		if(cmd.equals("internalcomponents_co"))  return internalcomponents_co;
