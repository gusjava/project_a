package a.entity.gus.y.server1.engine.cmd.e.count_hashedby;
...
public class EntityImpl implements Entity, T {
	...
	private Service hashedBy;
	private Service entityEngine;
	private Service joinArgs;

	public EntityImpl() throws Exception {
		hashedBy = Outside.service(this, "gus.y.entitydb1.entity.count.w_hash");
		entityEngine = Outside.service(this, "gus.y.entitysys1.engine");
		joinArgs     = Outside.service(this, "gus.y.server1.tool.args.fullstring");
	}

	public Object t(Object obj) throws Exception
	{return hashedBy.t(new Object[]{cx(), joinArgs(obj)});}
