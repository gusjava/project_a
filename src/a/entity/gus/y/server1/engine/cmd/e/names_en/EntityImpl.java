package a.entity.gus.y.server1.engine.cmd.e.names_en;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception {
		namesEn      = Outside.service(this, "gus.y.entitydb1.entity.names.w_en");
		entityEngine = Outside.service(this, "gus.y.entitysys1.engine");
		joinArgs     = Outside.service(this, "gus.y.server1.tool.args.fullstring");
	}

	public Object t(Object obj) throws Exception
	{return namesEn.t(new Object[]{cx(), joinArgs(obj)});}
