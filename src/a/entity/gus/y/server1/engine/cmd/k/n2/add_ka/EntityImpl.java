package a.entity.gus.y.server1.engine.cmd.k.n2.add_ka;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this, "gus.y.knowledgesys1.perform.knowledge_tag.add");
	...
	public Object t(Object obj) throws Exception
	{
		...
		return perform.t(new Object[]{cx(), id, tag});
	}
