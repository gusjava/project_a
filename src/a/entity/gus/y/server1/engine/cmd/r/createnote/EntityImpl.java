package a.entity.gus.y.server1.engine.cmd.r.createnote;
...
public class EntityImpl implements Entity, T {
	...
	{
		if(!(obj instanceof Map)) throw new Exception("r-createnote: JSON manquant (utiliser :<json>)");
		Map fields = (Map) obj;
		Connection cx = (Connection) roadmapCx.g();
		return sqlInsert.t(new Object[]{cx, buildInsert("note", fields)});
	}
