package a.entity.gus.y.server1.engine.cmd.r.createsprint;
...
public class EntityImpl implements Entity, T {
	...
	{
		if(!(obj instanceof Map)) throw new Exception("r-createsprint: JSON manquant (utiliser :<json>)");
		Map fields = (Map) obj;
		Connection cx = (Connection) roadmapCx.g();
		return sqlInsert.t(new Object[]{cx, buildInsert("sprint", fields)});
	}
