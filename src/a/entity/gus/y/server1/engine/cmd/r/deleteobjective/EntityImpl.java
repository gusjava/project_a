package a.entity.gus.y.server1.engine.cmd.r.deleteobjective;
...
public class EntityImpl implements Entity, T {
	...
	{
		List list = (List) obj;
		if(list == null || list.isEmpty()) throw new Exception("r-deleteobjective: id manquant");
		String id = (String) list.get(0);
		Connection cx = (Connection) roadmapCx.g();
		return sqlDelete.t(new Object[]{cx, "DELETE FROM objective WHERE id = " + id});
	}
}