package a.entity.gus.y.server1.engine.cmd.r.deletesprintentry;
...
public class EntityImpl implements Entity, T {
	...
	{
		List list = (List) obj;
		if(list == null || list.isEmpty()) throw new Exception("r-deletesprintentry: id manquant");
		String id = (String) list.get(0);
		Connection cx = (Connection) roadmapCx.g();
		return sqlDelete.t(new Object[]{cx, "DELETE FROM sprint_entry WHERE id = " + id});
	}
}