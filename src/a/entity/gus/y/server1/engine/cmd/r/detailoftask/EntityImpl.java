package a.entity.gus.y.server1.engine.cmd.r.detailoftask;
...
public class EntityImpl implements Entity, T {
	...
	{
		List list = (List) obj;
		if(list == null || list.isEmpty()) throw new Exception("r-detailoftask: id manquant");
		...
		ResultSet rs2 = st2.executeQuery("SELECT TAG FROM task_tag WHERE ID_TASK = " + id);
