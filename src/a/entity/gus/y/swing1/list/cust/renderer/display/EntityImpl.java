package a.entity.gus.y.swing1.list.cust.renderer.display;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		labelDisplay = Outside.service(this, "gus.y.swing1.label.cust2.display");
	}
