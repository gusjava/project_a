package a.entity.gus.y.swing1.list.cust.renderer.file.path;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		fileToIcon = Outside.service(this, "gus.y.files1.icon");
	}
	...
	private Icon icon(File f) {
		try {
			return (Icon) fileToIcon.t(f);
		} catch (Exception e) {
			Outside.err(this, "icon(File)", e);
		}
		return null;
	}
}