package a.entity.gus.y.swing1.textarea.buildscrollpane.linenb;
...
public class EntityImpl implements Entity, T {
	...
	private class JScrollPane1 extends JScrollPane
			implements DocumentListener, CaretListener, PropertyChangeListener, MouseListener {
		...
		private void performUpdate() {
			...
			if (lineNb == newLineNb && indexCaret == newIndexCaret)
				return;
