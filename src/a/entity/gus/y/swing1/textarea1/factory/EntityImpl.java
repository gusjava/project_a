package a.entity.gus.y.swing1.textarea1.factory;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception {
		documentFactory = Outside.service(this, "gus.y.swing1.textarea1.factory.plaindocument");
		undoableDelayBuilder = Outside.service(this, "gus.y.swing1.textarea1.plaindocument.undoable.delaybuilder");
	}
	...
	private class JTextArea1 extends JTextArea implements P, V, R {
		...
		public void v(String key, Object obj) throws Exception {
			if (key.equals("painter")) {
				l1.add((P) obj);
				return;
			}
			if (key.equals("formater")) {
				l2.add((T) obj);
				return;
			}
			if (key.equals("undoable")) {
				initUndoable(toBool(obj));
				return;
			}
	...
	private E getUndoable(Object doc) {
		try {
			return (E) undoableDelayBuilder.t(doc);
		} catch (Exception e) {
			Outside.err(this, "getUndoable(Object)", e);
		}
		return null;
	}
