package a.entity.gus.y.swing1.textarea1.factory.plaindocument;
...
public class EntityImpl implements Entity, G {
	...
	private void addActionListener(S s, ActionListener listener) {
		try {
			...
			Outside.err(this, "addActionListener(S,ActionListener)", e);
		}
	}
	...
	private void removeActionListener(S s, ActionListener listener) {
		try {
			...
			Outside.err(this, "removeActionListener(S,ActionListener)", e);
		}
	}
