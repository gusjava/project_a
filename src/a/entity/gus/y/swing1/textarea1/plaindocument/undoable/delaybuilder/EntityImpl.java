package a.entity.gus.y.swing1.textarea1.plaindocument.undoable.delaybuilder;
...
public class EntityImpl implements Entity, T {
	...
	private class Holder extends S1 implements E, G, F {
		...
		private void checkClosed() throws Exception {
			if (doc == null)
				throw new Exception("Attempt to use a delay builder which has already been closed");
		}
	}
}
