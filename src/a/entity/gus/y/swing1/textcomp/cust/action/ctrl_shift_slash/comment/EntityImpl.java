package a.entity.gus.y.swing1.textcomp.cust.action.ctrl_shift_slash.comment;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		perform = Outside.service(this, "gus.y.swing1.textcomp.cust.action.ctrl_shift_slash.comment.perform");
