package a.entity.gus.y.swingactions1.alt_down.gotodown;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "alt down";
	
	private Service perform;
	private Service stringToKeyStroke;
	
	public EntityImpl() throws Exception {
		perform = Outside.service(this,"gus.y.swingactions1.alt_down.gotodown.perform");
