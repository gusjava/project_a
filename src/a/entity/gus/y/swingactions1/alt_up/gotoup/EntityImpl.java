package a.entity.gus.y.swingactions1.alt_up.gotoup;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "alt up";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.alt_up.gotoup.perform");
