package a.entity.gus.y.swingactions1.ctrl_d.removeline;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl d";

	private Service perform;
	private Service stringToKeyStroke;

	public EntityImpl() throws Exception {
		perform = Outside.service(this, "gus.y.swingactions1.ctrl_d.removeline.perform");
