package a.entity.gus.y.swingactions1.ctrl_left.select.back;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl left";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.ctrl_left.select.back.perform");
