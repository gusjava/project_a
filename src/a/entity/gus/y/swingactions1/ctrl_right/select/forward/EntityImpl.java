package a.entity.gus.y.swingactions1.ctrl_right.select.forward;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl right";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.ctrl_right.select.forward.perform");
