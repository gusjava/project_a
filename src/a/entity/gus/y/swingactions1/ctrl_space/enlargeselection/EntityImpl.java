package a.entity.gus.y.swingactions1.ctrl_space.enlargeselection;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl space";

	private Service perform;
	private Service stringToKeyStroke;

	public EntityImpl() throws Exception {
		perform = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform");
