package a.entity.gus.y.swingactions1.ctrl_space.enlargeselection.perform.p1;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		performMore = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform.p2");
