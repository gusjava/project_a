package a.entity.gus.y.swingactions1.ctrl_space.enlargeselection.perform.p4;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		performMore = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform.q1");
		buildDelim = Outside.service(this, "gus.x.string.split.words4.delim");
