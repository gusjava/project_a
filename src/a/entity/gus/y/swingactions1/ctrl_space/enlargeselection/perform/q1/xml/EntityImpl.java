package a.entity.gus.y.swingactions1.ctrl_space.enlargeselection.perform.q1.xml;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		goForward = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform.q1.xml.goforward");
		goBack = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform.q1.xml.goback");
