package a.entity.gus.y.swingactions1.ctrl_space.enlargeselection.perform.q2;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception {
		performZ2 = Outside.service(this, "gus.y.swingactions1.ctrl_space.enlargeselection.perform.q3");
	}
	...
	public void p(Object obj) throws Exception {
		...
		while (start2 >= 0 && !isLineDelim(text.charAt(start2))) {
			if (!isWhiteChar(text.charAt(start2)))
				start1 = start2 - 1;
			start2--;
		}
		while (end2 < length && !isLineDelim(text.charAt(end2))) {
			if (!isWhiteChar(text.charAt(end2)))
				end1 = end2 + 1;
			end2++;
		}
