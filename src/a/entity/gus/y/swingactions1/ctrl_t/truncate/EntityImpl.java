package a.entity.gus.y.swingactions1.ctrl_t.truncate;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl t";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.ctrl_t.truncate.perform");
