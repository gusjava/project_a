package a.entity.gus.y.swingactions1.ctrl_up.select.before;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl up";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.ctrl_up.select.before.perform");
