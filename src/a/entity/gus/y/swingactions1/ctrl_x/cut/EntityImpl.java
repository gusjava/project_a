package a.entity.gus.y.swingactions1.ctrl_x.cut;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY = "ctrl x";
	...
	{
		perform = Outside.service(this,"gus.y.swingactions1.ctrl_x.cut.perform");
