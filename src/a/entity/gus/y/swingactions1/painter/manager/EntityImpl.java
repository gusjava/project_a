package a.entity.gus.y.swingactions1.painter.manager;
...
public class EntityImpl implements Entity, R {
	...
	public EntityImpl() throws Exception {
		buildPainter = Outside.service(this, "gus.y.swingactions1.painter.builder");
	...
	public Object r(String key) throws Exception {
		if (key.equals(KEY_SEARCH))
			return painter_search;
		if (key.equals(KEY_SEARCH_I))
			return painter_search_i;
		if (key.equals(KEY_REGEX))
			return painter_regex;
		if (key.equals(KEY_HIGH1))
			return painter_high1;
		if (key.equals(KEY_HIGH1))
			return painter_high1;
		if (key.equals(KEY_REPLACE))
			return painter_replace;
		if (key.equals(KEY_F1))
			return painter_f1;
