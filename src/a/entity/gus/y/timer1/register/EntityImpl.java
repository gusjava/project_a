package a.entity.gus.y.timer1.register;
...
public class EntityImpl implements Entity, V, T {
	...
	public EntityImpl() throws Exception {
		executeToTask = Outside.service(this, "gus.x.features.e.totimertask");
		buildDelayHolder = Outside.service(this, "gus.y.timer1.build.delayholder");
