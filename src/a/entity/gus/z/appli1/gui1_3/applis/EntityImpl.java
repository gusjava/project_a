package a.entity.gus.z.appli1.gui1_3.applis;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception {
		docView = Outside.service(this, "*gus.y.docview1.gui4a");
		appEntries = Outside.service(this, "gus.y.appentries1.self");
		icon = (Icon) Outside.resource(this, "icon#ELEMENT_appli");
	...
	private Map buildPathsByDev() throws Exception {
		...
		while (it.hasNext()) {
			...
			String root = "a/config/" + dev + "/doc1/fr/app/";
