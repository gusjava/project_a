package a.entity.gus06.app.execute.about.panel;
...
public class EntityImpl implements Entity, I {
	...
	public static final String MESSAGE_CREATEDBY = "Application cr��e par ";
	public static final String MESSAGE_INCOMPLETE = "Version non finalis�e!";
	public static final String MESSAGE_UNDEFINED = "ind�fini";
	...
	{
		labelWebApp = Outside.service(this,"*gus06.app.info.appli.website.label");
		labelWebGus06 = Outside.service(this,"*gus06.app.info.framework.website.label");
		labelMail = Outside.service(this,"*gus06.app.info.author.email.label");
		getCopyright = Outside.service(this,"gus06.app.info.framework.copyright");
		
		icon_gus06 = (Icon) Outside.resource(this,"icon#gus06_big");
		icon_app = (Icon) Outside.resource(this,"icon#APP2");
