package a.entity.gus06.app.jarfile.listing.java.filter.en;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		listing = Outside.service(this,"gus06.app.jarfile.listing.java");
		filterBuilder = Outside.service(this,"gus06.filter.string.build.endswith");
	}
