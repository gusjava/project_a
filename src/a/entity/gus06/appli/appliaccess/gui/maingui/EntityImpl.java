package a.entity.gus06.appli.appliaccess.gui.maingui;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception
	{
		...
		bottomBar = Outside.service(this,"*gus06.appli.appliaccess.gui.bottombar");
		downloadGui = Outside.service(this,"*gus06.appli.appliaccess.gui.download");
		debugGui = Outside.service(this,"*gus06.debug.gui.maingui");
		settingGui = Outside.service(this,"*gus06.appli.appliaccess.gui.settings");
