package a.entity.gus06.appli.gusclient1.action.entity.full.cdle;
...
public class EntityImpl implements Entity, G, E {
	...
	public static final String DISPLAY = "Full cycle (CDLE)";
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.entity.full.cdle");
