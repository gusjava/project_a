package a.entity.gus06.appli.gusclient1.action.entity.opendir;
...
public class EntityImpl implements Entity, G, E {
	...
	public static final String DISPLAY = "Open directory";
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.entity.opendir");
