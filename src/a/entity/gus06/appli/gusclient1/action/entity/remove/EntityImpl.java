package a.entity.gus06.appli.gusclient1.action.entity.remove;
...
public class EntityImpl implements Entity, G, E {
	...
	public static final String DISPLAY = "Remove entity";
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.entity.remove");
