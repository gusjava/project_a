package a.entity.gus06.appli.gusclient1.action.entity.toclipboard.src;
...
public class EntityImpl implements Entity, G, E {
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.entity.toclipboard.src");
