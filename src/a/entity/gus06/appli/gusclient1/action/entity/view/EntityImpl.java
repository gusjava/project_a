package a.entity.gus06.appli.gusclient1.action.entity.view;
...
public class EntityImpl implements Entity, G, E {
	...
	public static final String DISPLAY = "4 - View entity object";
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.entity.view");
