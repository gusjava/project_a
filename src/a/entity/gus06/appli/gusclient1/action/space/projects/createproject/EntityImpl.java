package a.entity.gus06.appli.gusclient1.action.space.projects.createproject;
...
public class EntityImpl implements Entity, E, G {
	...
	{
		execute = Outside.service(this,"gus06.appli.gusclient1.execute.space.projects.createproject");
