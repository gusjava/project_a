package a.entity.gus06.appli.gusclient1.gui.space.projects.analyzer.path;
...
public class EntityImpl implements Entity, ActionListener, I {
	...
	{
		loadConfig = Outside.service(this,"gus06.appli.gusclient1.project.config.load2.path");
