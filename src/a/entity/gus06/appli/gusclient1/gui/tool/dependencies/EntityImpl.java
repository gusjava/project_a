package a.entity.gus06.appli.gusclient1.gui.tool.dependencies;
...
public class EntityImpl implements Entity, ActionListener, I, P {
	...
	public EntityImpl() throws Exception
	{
		...
		engine = Outside.service(this,"gus06.appli.gusclient1.gui.tool.dependencies.engine");
		
		button = new JButton("Search for dependencies");
