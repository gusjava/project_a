package a.entity.gus06.appli.gusexplorer.action.tabs.add.scriptdir.tools;
...
public class EntityImpl implements Entity, G, E {
	...
	{
		execute = Outside.service(this,"gus06.appli.gusexplorer.execute.tabs.add.scriptdir.tools");
