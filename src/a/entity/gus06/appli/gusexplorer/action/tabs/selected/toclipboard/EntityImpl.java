package a.entity.gus06.appli.gusexplorer.action.tabs.selected.toclipboard;
...
public class EntityImpl implements Entity, G, E {
	...
	{
		execute = Outside.service(this,"gus06.appli.gusexplorer.execute.tabs.selected.toclipboard");
