package a.entity.gus06.appli.gusexplorer.execute.tabs.add.scriptdir.h.db;
...
public class EntityImpl implements Entity, E {
	...
	public EntityImpl() throws Exception
	{
		...
		dirHolder = Outside.service(this,"gus06.jdbc.gui.cx1.db.list.control.script.manager");
	}
