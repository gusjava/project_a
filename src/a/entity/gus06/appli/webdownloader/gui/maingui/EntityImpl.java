package a.entity.gus06.appli.webdownloader.gui.maingui;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception
	{
		...
		bottomBar = Outside.service(this,"*gus06.appli.webdownloader.gui.bottombar");
		downloadGui = Outside.service(this,"*gus06.appli.webdownloader.gui.download");
		settingGui = Outside.service(this,"*gus06.appli.webdownloader.gui.settings");
