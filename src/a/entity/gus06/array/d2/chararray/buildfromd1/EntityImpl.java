package a.entity.gus06.array.d2.chararray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private char findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? toChar(l.get(pos)) : ' ';
		}
		if(row instanceof char[])
		{
			char[] l = (char[]) row;
			return pos<l.length ? l[pos] : ' ';
		}
