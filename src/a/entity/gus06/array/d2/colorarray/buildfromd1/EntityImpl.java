package a.entity.gus06.array.d2.colorarray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private Color findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (Color) l.get(pos) : null;
		}
		if(row instanceof Color[])
		{
			Color[] l = (Color[]) row;
