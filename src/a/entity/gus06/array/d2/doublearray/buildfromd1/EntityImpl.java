package a.entity.gus06.array.d2.doublearray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		double[][] table = new double[nb1][nb2];
	...
	private double findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? ((Number) l.get(pos)).doubleValue() : 0;
		}
