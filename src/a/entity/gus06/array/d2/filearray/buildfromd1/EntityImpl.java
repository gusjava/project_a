package a.entity.gus06.array.d2.filearray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private File findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (File) l.get(pos) : null;
		}
