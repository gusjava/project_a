package a.entity.gus06.array.d2.floatarray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private float findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? ((Number) l.get(pos)).floatValue() : 0;
		}
		if(row instanceof float[])
		{
			float[] l = (float[]) row;
