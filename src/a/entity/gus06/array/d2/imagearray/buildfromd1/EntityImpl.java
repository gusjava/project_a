package a.entity.gus06.array.d2.imagearray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private Image findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (Image) l.get(pos) : null;
		}
