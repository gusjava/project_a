package a.entity.gus06.array.d2.listarray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private List findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (List) l.get(pos) : null;
		}
		if(row instanceof List[])
		{
			List[] l = (List[]) row;
