package a.entity.gus06.array.d2.maparray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private Map findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (Map) l.get(pos) : null;
		}
