package a.entity.gus06.array.d2.setarray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private Set findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (Set) l.get(pos) : null;
		}
