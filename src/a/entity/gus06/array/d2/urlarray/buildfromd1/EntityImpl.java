package a.entity.gus06.array.d2.urlarray.buildfromd1;
...
public class EntityImpl implements Entity, T {
	...
	private URL findAt(Object row, int pos) throws Exception
	{
		if(row instanceof List)
		{
			List l = (List) row;
			return pos<l.size() ? (URL) l.get(pos) : null;
		}
