package a.entity.gus06.data.editor.renderedimage.editor1.action.flip.diagonal;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_flip_diagonal#Flip diagonal";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.flip.diagonal");
