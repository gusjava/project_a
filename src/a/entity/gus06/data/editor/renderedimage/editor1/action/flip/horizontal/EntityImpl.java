package a.entity.gus06.data.editor.renderedimage.editor1.action.flip.horizontal;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_flip_horizontal#Flip horizontal";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.flip.horizontal");
