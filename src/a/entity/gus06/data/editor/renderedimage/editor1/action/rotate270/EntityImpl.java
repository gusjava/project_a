package a.entity.gus06.data.editor.renderedimage.editor1.action.rotate270;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_rotation_270#Rotate 270";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.rotate270");
