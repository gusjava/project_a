package a.entity.gus06.data.editor.renderedimage.editor2.action.color.darken;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_darken#Darken";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.color.darken");
