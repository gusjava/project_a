package a.entity.gus06.data.editor.renderedimage.editor2.action.color.invert.centerband;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_invert_centerband#Invert center band";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.color.invert.centerband");
