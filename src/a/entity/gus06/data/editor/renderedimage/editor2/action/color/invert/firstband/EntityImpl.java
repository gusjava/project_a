package a.entity.gus06.data.editor.renderedimage.editor2.action.color.invert.firstband;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_invert_firstband#Invert first band";
