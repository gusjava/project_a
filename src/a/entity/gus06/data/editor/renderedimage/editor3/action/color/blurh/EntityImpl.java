package a.entity.gus06.data.editor.renderedimage.editor3.action.color.blurh;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_blurh#Blur horizontal";
	...
	{
		perform = Outside.service(this,"gus06.awt.bufferedimage.transform.color.blurhorizontal");
