package a.entity.gus06.data.editor.renderedimage.editor3.action.color.blurv;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_blurv#Blur vertical";
	...
	{
		perform = Outside.service(this,"gus06.awt.bufferedimage.transform.color.blurvertical");
