package a.entity.gus06.data.editor.renderedimage.editor3.action.color.discretize1;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_color_discretize1#Discretize level 1";
	...
	{
		perform = Outside.service(this,"gus06.awt.bufferedimage.transform.color.discretize1");
