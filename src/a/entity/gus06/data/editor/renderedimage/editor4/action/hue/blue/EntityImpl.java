package a.entity.gus06.data.editor.renderedimage.editor4.action.hue.blue;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_hue_blue#Hue blue";
	...
	{
		perform = Outside.service(this,"gus06.awt.bufferedimage.transform.color.hue.blue");
