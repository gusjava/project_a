package a.entity.gus06.data.editor.renderedimage.editor4.action.hue.cyan;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_hue_cyan#Hue cyan";
	...
	{
		perform = Outside.service(this,"gus06.awt.bufferedimage.transform.color.hue.cyan");
