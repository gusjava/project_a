package a.entity.gus06.data.editor.renderedimage.editor5.action.kernel.convolve;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "IMG_kernel_convolve#Convolve";
	...
	{
		perform = Outside.service(this,"gus06.awt.renderedimage.transform.kernel.convolve");
