package a.entity.gus06.data.editor.string.iconkey.dialog;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DEFAULT_TITLE = "Icon key chooser";
	...
	{
		editor = Outside.service(this,"*gus06.data.editor.string.iconkey");
