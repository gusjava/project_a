package a.entity.gus06.data.filter.check.any;
...
public class EntityImpl implements Entity, F {
	...
	{
		filterList = Outside.service(this,"gus06.list.check.any");
		filterSet = Outside.service(this,"gus06.set.check.any");
		filterMap = Outside.service(this,"gus06.map.key.check.any");
	}	
