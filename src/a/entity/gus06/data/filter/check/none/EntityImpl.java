package a.entity.gus06.data.filter.check.none;
...
public class EntityImpl implements Entity, F {
	...
	{
		filterList = Outside.service(this,"gus06.list.check.none");
		filterSet = Outside.service(this,"gus06.set.check.none");
		filterMap = Outside.service(this,"gus06.map.key.check.none");
	}	
