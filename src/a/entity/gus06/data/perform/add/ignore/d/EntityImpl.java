package a.entity.gus06.data.perform.add.ignore.d;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performSet = Outside.service(this,"gus06.set.add.ignore.d");
		performList = Outside.service(this,"gus06.list.add.ignore.d");
	}
