package a.entity.gus06.data.perform.addall.ignore;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performSet = Outside.service(this,"gus06.set.addall.ignore");
		performList = Outside.service(this,"gus06.list.addall.ignore");
	}
