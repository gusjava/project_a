package a.entity.gus06.data.perform.changekey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.key.change");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.rename");
	}
