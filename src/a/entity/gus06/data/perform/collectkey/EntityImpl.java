package a.entity.gus06.data.perform.collectkey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performFile = Outside.service(this,"gus06.dirfile.perform.eachkey.transform");
		performMap = Outside.service(this,"gus06.map.key.collect");
	}
