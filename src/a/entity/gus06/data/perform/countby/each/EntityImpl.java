package a.entity.gus06.data.perform.countby.each;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus06.list.countby.each");
		performSet = Outside.service(this,"gus06.set.countby.each");
