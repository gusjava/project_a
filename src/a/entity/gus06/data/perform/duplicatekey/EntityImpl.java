package a.entity.gus06.data.perform.duplicatekey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.key.duplicate");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.duplicate");
	}
