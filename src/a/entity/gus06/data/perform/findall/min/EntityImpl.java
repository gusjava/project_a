package a.entity.gus06.data.perform.findall.min;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus06.list.findall.min");
		performSet = Outside.service(this,"gus06.set.findall.min");
		performArray = Outside.service(this,"gus06.array.objectarray.findall.min");
		performArray2 = Outside.service(this,"gus06.array.d2.objectarray.findall.min");
	}
