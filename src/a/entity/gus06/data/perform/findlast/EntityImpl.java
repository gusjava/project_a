package a.entity.gus06.data.perform.findlast;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus06.list.findlast");
		performArray = Outside.service(this,"gus06.array.objectarray.findlast");
		performDoubleArray = Outside.service(this,"gus06.array.doublearray.findlast");
		performIntArray = Outside.service(this,"gus06.array.intarray.findlast");
	}	
