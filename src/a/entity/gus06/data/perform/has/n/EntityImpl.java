package a.entity.gus06.data.perform.has.n;
...
public class EntityImpl implements Entity, T {
	...
	{
		colContains = Outside.service(this,"gus06.collection.contains.coltof.n");
		mapContainsKey = Outside.service(this,"gus06.map.contains.key.maptof.n");
		arrayContains = Outside.service(this,"gus06.array.contains.arraytof.n");
	}
