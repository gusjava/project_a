package a.entity.gus06.data.perform.hasall;
...
public class EntityImpl implements Entity, T {
	...
	{
		colContainsAll = Outside.service(this,"gus06.collection.containsall.coltof");
		mapContainsKeyAll = Outside.service(this,"gus06.map.containsall.key.maptof");
		arrayContainsAll = Outside.service(this,"gus06.array.containsall.arraytof");
	}
