package a.entity.gus06.data.perform.hasall.n;
...
public class EntityImpl implements Entity, T {
	...
	{
		colContainsAll = Outside.service(this,"gus06.collection.containsall.coltof.n");
		mapContainsKeyAll = Outside.service(this,"gus06.map.containsall.key.maptof.n");
		arrayContainsAll = Outside.service(this,"gus06.array.containsall.arraytof.n");
	}
