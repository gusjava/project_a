package a.entity.gus06.data.perform.indexof.first;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleArray = Outside.service(this,"gus06.array.indexof.first");
		handleList = Outside.service(this,"gus06.list.indexof.first");
		handleString = Outside.service(this,"gus06.string.indexof.first");
	}
