package a.entity.gus06.data.perform.keep;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performList = Outside.service(this,"gus06.list.keep");
		performSet = Outside.service(this,"gus06.set.keep");
		performMap = Outside.service(this,"gus06.map.keep");
	}
