package a.entity.gus06.data.perform.mapkey2;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus06.list.mapkey2");
		performSet = Outside.service(this,"gus06.set.mapkey2");
		performArray = Outside.service(this,"gus06.array.objectarray.mapkey2");
	}	
