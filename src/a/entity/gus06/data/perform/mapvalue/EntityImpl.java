package a.entity.gus06.data.perform.mapvalue;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus06.list.mapvalue");
		performSet = Outside.service(this,"gus06.set.mapvalue");
		performArray = Outside.service(this,"gus06.array.objectarray.mapvalue");
	}	
