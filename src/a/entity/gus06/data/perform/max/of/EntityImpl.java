package a.entity.gus06.data.perform.max.of;
...
public class EntityImpl implements Entity, T {
	...
	{
		performArray = Outside.service(this,"gus06.array.objectarray.max.of");
		performList = Outside.service(this,"gus06.list.max.of");
	}
