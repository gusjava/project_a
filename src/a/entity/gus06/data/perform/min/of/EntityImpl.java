package a.entity.gus06.data.perform.min.of;
...
public class EntityImpl implements Entity, T {
	...
	{
		performArray = Outside.service(this,"gus06.array.objectarray.min.of");
		performList = Outside.service(this,"gus06.list.min.of");
	}
