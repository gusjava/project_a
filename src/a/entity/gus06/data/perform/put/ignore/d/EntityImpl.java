package a.entity.gus06.data.perform.put.ignore.d;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.put.ignore.d");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.put.ignore.d");
	}
