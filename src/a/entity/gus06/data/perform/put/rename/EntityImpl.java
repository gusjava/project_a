package a.entity.gus06.data.perform.put.rename;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.put.rename");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.put.rename");
	}
