package a.entity.gus06.data.perform.put.strict;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.put.strict");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.put.strict");
	}
