package a.entity.gus06.data.perform.putall.ignore.d;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.putall.ignore.d");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.putall.ignore.d");
	}
