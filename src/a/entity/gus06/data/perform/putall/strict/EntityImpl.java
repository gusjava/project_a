package a.entity.gus06.data.perform.putall.strict;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.putall.strict");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.putall.strict");
	}
