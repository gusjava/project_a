package a.entity.gus06.data.perform.putnow;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.putnow");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.putnow");
	}
