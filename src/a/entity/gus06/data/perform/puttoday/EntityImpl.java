package a.entity.gus06.data.perform.puttoday;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus06.map.puttoday");
		performFile = Outside.service(this,"gus06.file.properties.perform.field.puttoday");
	}
