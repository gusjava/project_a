package a.entity.gus06.data.perform.rotate270;
...
public class EntityImpl implements Entity, T {
	...
	{
		rotateJPanel = Outside.service(this,"gus06.swing.panel.rotate270.grid");
		rotateJTabbedPane = Outside.service(this,"gus06.swing.tabbedpane.rotate270");
		rotateJSplitPane = Outside.service(this,"gus06.swing.splitpane.rotate270");
		rotateImage = Outside.service(this,"gus06.awt.renderedimage.transform.rotate270");
	}
