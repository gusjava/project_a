package a.entity.gus06.data.perform.rotate90;
...
public class EntityImpl implements Entity, T {
	...
	{
		rotateJPanel = Outside.service(this,"gus06.swing.panel.rotate90.grid");
		rotateJTabbedPane = Outside.service(this,"gus06.swing.tabbedpane.rotate90");
		rotateJSplitPane = Outside.service(this,"gus06.swing.splitpane.rotate90");
		rotateImage = Outside.service(this,"gus06.awt.renderedimage.transform.rotate90");
	}
