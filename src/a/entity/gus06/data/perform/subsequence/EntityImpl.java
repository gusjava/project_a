package a.entity.gus06.data.perform.subsequence;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		stringSub = Outside.service(this,"gus06.data.string.subsequence");
		listSub = Outside.service(this,"gus06.data.list.subsequence");
