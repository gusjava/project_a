package a.entity.gus06.data.perform.sum1.of;
...
public class EntityImpl implements Entity, T {
	...
	{
		performArray = Outside.service(this,"gus06.array.objectarray.sum1.of");
		performList = Outside.service(this,"gus06.list.sum1.of");
	}
