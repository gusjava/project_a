package a.entity.gus06.data.perform.trim.end;
...
public class EntityImpl implements Entity, T {
	...
	{
		performString = Outside.service(this,"gus06.string.transform.str.trim.end");
		performList = Outside.service(this,"gus06.list.trim.end");
		performArray = Outside.service(this,"gus06.array.trim.end");
	}
