package a.entity.gus06.dir.perform.searchfiles.filtername0;
...
public class EntityImpl implements Entity, T {
	...
	private void handleFile(F filter, List output, File input) throws Exception
	{
		...
		else if(filter.f(getName0(input))) output.add(input);
	}
	
	private String getName0(File input) throws Exception
	{return (String) getName0.t(input);}
}