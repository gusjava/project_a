package a.entity.gus06.dir.runtask.convert.icon.asico;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		generate = Outside.service(this,"gus06.file.perform.generate.icon.asico");
	}
	...
	public void p(Object obj) throws Exception
	{
		...
		File dir1 = new File(dir.getAbsolutePath()+"_icon_ico");
		dir1.mkdirs();
		...
		{
			File f = (File) l.get(i);
			File f1 = new File(dir1,f.getName()+".ico");
