package a.entity.gus06.dir.runtask.convert.jpg.small3;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		generate = Outside.service(this,"gus06.file.perform.generate.jpg.small3");
	}
	...
	public void p(Object obj) throws Exception
	{
		...
		File dir1 = new File(dir.getAbsolutePath()+"_"+EXT+"_small3");
		dir1.mkdirs();
		...
		{
			File f = (File) l.get(i);
			File f1 = new File(dir1,f.getName()+"_small3."+EXT);
