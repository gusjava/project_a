package a.entity.gus06.dir.runtask.corpus.properties.field.duplicate;
...
public class EntityImpl implements Entity, P {
	...
	public static final String MESSAGE = "Duplicate field: ";
	...
	public EntityImpl() throws Exception
	{
		...
		op = Outside.service(this,"gus06.file.properties.perform.field.duplicate");
	...
	public void p(Object obj) throws Exception
	{
		...
		String newName = chooseName(field);
		if(newName==null || newName.equals("") || newName.equals(field))
		{interrupt.add("*");return;}
		
		for(File f:ff)
		{
			op.p(new Object[]{f,field,newName});
			if(progress!=null) ((E)progress).e();
			if(interrupt!=null && !interrupt.isEmpty()) break;
		}
	}
	...
	private String chooseName(String field) throws Exception
	{
