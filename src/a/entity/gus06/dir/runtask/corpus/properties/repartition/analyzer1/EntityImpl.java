package a.entity.gus06.dir.runtask.corpus.properties.repartition.analyzer1;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		categorizer = Outside.service(this,"gus06.string.transform.categorize.code1");
	}
	...
	public void p(Object obj) throws Exception
	{
		...
		File dir1 = new File(dir.getAbsolutePath()+"_rep1");
		dir1.mkdirs();
