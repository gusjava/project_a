package a.entity.gus06.dir.runtask.corpus.text.report.concatall.utf8;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		readFile = Outside.service(this,"gus06.file.read.string.cs.utf8");
	}
	...
	public void p(Object obj) throws Exception
	{
		...
		PrintStream p = new PrintStream(reportFile,CHARSET.name());
