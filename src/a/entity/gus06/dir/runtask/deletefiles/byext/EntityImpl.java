package a.entity.gus06.dir.runtask.deletefiles.byext;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception
	{
		...
		String input = (String) getInput.t("Enter target file extension for deletion:");
		...
		{
			File f = (File) l.get(i);
			String ext_ = (String) getExtension.t(f);
			for(String ext : exts) if(ext.equals(ext_))
			{
				toDelete.add(f);
				sb.append(f+"\n"); 
				break;
