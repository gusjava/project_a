package a.entity.gus06.dir.runtask.extract.mv.extension;
...
public class EntityImpl implements Entity, P {
	...
	private void handle(File f, File dir, String ext)
	{
		...
		{
			if(isType(f,ext))
			moveInsideDir.p(new File[]{f,dir});
		}
		catch(Exception e)
