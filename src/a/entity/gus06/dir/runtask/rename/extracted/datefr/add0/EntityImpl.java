package a.entity.gus06.dir.runtask.rename.extracted.datefr.add0;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		rename = Outside.service(this,"gus06.file.perform.rename.extracted.datefr.add0");
	}
	...
	{
		try{rename.p(f);}
		catch(Exception e){Outside.err(this,"rename(File)",e);}
	}
}