package a.entity.gus06.dir.runtask.rename.name0.addtoint;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		rename = Outside.service(this,"gus06.file.perform.rename.name0.addtoint");
	...
	public void p(Object obj) throws Exception
	{
		...
		String seq = (String) getInput.t("Enter added integer:");
