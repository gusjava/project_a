package a.entity.gus06.dir.runtask.rename.name0.replace;
...
public class EntityImpl implements Entity, P {
	...
	public String creationDate() {return "20190425";}
	...
	public EntityImpl() throws Exception
	{
		...
		rename = Outside.service(this,"gus06.file.perform.rename.name0.replace");
	...
	public void p(Object obj) throws Exception
	{
		...
		String repl = (String) getInput.t("Enter replacement:");
		if(repl==null || seq.equals(repl)) return;
		...
		{
			File f = (File) l.get(i);
			rename.p(new Object[]{f,seq,repl});
