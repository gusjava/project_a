package a.entity.gus06.dir.runtask.rename.name0.substr;
...
public class EntityImpl implements Entity, P {
	...
	public String creationDate() {return "20250206";}
	...
	public EntityImpl() throws Exception
	{
		...
		rename = Outside.service(this,"gus06.file.perform.rename.name0.substr");
	...
	public void p(Object obj) throws Exception
	{
		...
		String seq = (String) getInput.t("Enter substring rule:");
