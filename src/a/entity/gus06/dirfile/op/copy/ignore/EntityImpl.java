package a.entity.gus06.dirfile.op.copy.ignore;
...
public class EntityImpl implements Entity, P {
	...
	{
		copyDir = Outside.service(this,"gus06.dir.op.copy.ignore");
		copyFile = Outside.service(this,"gus06.file.op.copy.ignore");
	}
