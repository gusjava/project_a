package a.entity.gus06.dirfile.perform.each.transform;
...
public class EntityImpl implements Entity, P {
	...
	{
		handleProp = Outside.service(this,"gus06.file.properties.perform.each.keyvalue.transform");
		handleTxt = Outside.service(this,"gus06.file.string.perform.lines.apply.t");
