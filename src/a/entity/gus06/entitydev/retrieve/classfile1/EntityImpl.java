package a.entity.gus06.entitydev.retrieve.classfile1;
...
public class EntityImpl implements Entity, T {
	...
	{
		retrieve = Outside.service(this,"gus06.entitydev.retrieve.classfile");
		rootDir = (File) Outside.resource(this,"path#path.dev.bindir");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(rootDir==null)
			throw new Exception("Unknown root path for entity class");
