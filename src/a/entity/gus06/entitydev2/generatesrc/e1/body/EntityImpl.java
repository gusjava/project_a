package a.entity.gus06.entitydev2.generatesrc.e1.body;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(return_!=null) throw new Exception("Invalid method for E: "+method);
		if(!params.isEmpty()) throw new Exception("Invalid method for E: "+method);
