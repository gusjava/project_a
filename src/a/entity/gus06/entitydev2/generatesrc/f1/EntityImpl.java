package a.entity.gus06.entitydev2.generatesrc.f1;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildBody = Outside.service(this,"gus06.entitydev2.generatesrc.f1.body");
	...
	public Object t(Object obj) throws Exception
	{
		...
		sb.append("public class EntityImpl implements Entity, F {\n\n");
		sb.append((String) creationDate.g());
		sb.append("\tpublic boolean f(Object obj) throws Exception\n");
		sb.append("\t{\n");
		sb.append(buildBodyFromMethod(method)+"\n");
		sb.append("\t}\n");
		sb.append("}");
		return sb.toString();
	}
	...
	private String buildBodyFromMethod(String method) throws Exception
