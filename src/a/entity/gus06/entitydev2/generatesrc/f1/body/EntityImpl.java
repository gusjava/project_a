package a.entity.gus06.entitydev2.generatesrc.f1.body;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(return_==null) throw new Exception("Invalid method for F: "+method);
		if(params.isEmpty()) throw new Exception("Invalid method for F: "+method);
		if(!return_.equals("booleam")) throw new Exception("Invalid method for F: "+method);
