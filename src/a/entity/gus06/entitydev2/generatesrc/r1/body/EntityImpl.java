package a.entity.gus06.entitydev2.generatesrc.r1.body;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(return_==null) throw new Exception("Invalid method for R: "+method);
		if(params.size()!=1) throw new Exception("Invalid method for R: "+method);
		if(!params.get(0).equals("String")) throw new Exception("Invalid method for R: "+method);
