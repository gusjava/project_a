package a.entity.gus06.entitydev2.generatesrc.t1;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildBody = Outside.service(this,"gus06.entitydev2.generatesrc.t1.body");
	...
	public Object t(Object obj) throws Exception
	{
		...
		sb.append("public class EntityImpl implements Entity, T {\n\n");
		sb.append((String) creationDate.g());
		sb.append("\tpublic Object t(Object obj) throws Exception\n");
		sb.append("\t{\n");
