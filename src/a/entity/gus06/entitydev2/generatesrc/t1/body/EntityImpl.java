package a.entity.gus06.entitydev2.generatesrc.t1.body;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(return_==null) throw new Exception("Invalid method for T: "+method);
		if(params.isEmpty()) throw new Exception("Invalid method for T: "+method);
