package a.entity.gus06.feature.extend.gui.south;
...
public class EntityImpl implements Entity, T {
	...
	private class Wrap implements E, G, P, T, F, H, I, R, V, S
	{
		...
		public Wrap(Object main, Object extension) throws Exception
		{
		...
		private void initPanel() throws Exception
		{
			...
			panel.add((JComponent) i.i(), BorderLayout.CENTER);
			panel.add(extensionComp(), BorderLayout.SOUTH);
		}
		
		private JComponent extensionComp() throws Exception
		{
			if(extension instanceof JComponent) return (JComponent) extension;
			if(extension instanceof I) return (JComponent) ((I) extension).i();
			
			throw new Exception("Invalid extension type: "+extension.getClass().getName());
		}
	}
}