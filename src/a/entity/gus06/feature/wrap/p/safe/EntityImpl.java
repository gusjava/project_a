package a.entity.gus06.feature.wrap.p.safe;
...
public class EntityImpl implements Entity, T {
	...
	{return new SafeP((P) obj);}
	
	
	private class SafeP implements P
	{
		private P p;
		public SafeP(P p){this.p = p;}
		
		public void p(Object obj) throws Exception
		{
			Runnable1 ru = new Runnable1(p,obj);
	...
	private class Runnable1 implements Runnable, UncaughtExceptionHandler
	{
		...
		public Runnable1(P p, Object input)
		{
			this.p = p;
			this.input = input;
		}
