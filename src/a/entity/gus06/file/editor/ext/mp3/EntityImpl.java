package a.entity.gus06.file.editor.ext.mp3;
...
public class EntityImpl extends S1 implements Entity, ActionListener, I, P, G, R, Runnable {
	...
	{
		play = Outside.service(this,"gus06.file.mp3.play");
		formPanel = Outside.service(this,"*gus06.file.mp3.gui.metadata.form1");
