package a.entity.gus06.file.editor.ext.python.console;
...
public class EntityImpl implements Entity, I, P, ActionListener {
	...
	public String creationDate() {return "20240830";}
	...
	private void executeFile(File file, String s)
	{
		try
		{
			...
			File f = new File(root,"tmp.python");
