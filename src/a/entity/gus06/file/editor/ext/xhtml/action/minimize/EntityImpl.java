package a.entity.gus06.file.editor.ext.xhtml.action.minimize;
...
public class EntityImpl implements Entity, T {
	...
	public static final String DISPLAY = "TEXT_minimize#Minimize code";
	...
	{
		perform = Outside.service(this,"gus06.string.transform.xhtml.compact");
