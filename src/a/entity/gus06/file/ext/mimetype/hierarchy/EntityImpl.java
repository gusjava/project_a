package a.entity.gus06.file.ext.mimetype.hierarchy;
...
public class EntityImpl implements Entity, T, R {
	...
	private Service fileToMimeHier;
	...
	{
		fileToMimeHier = Outside.service(this,"gus06.file.mime.tika.hierarchy.list");
	...
	private String build(String ext) throws Exception
	{
		...
		return (String) fileToMimeHier.t(file);
	}
}
