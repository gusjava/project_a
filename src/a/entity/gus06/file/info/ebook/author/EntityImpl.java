package a.entity.gus06.file.info.ebook.author;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMobi = Outside.service(this,"gus06.file.mobi.properties.author");
		handleEpub = Outside.service(this,"gus06.file.epub.properties.author");
