package a.entity.gus06.file.info.ebook.publisher;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMobi = Outside.service(this,"gus06.file.mobi.properties.publisher");
		handleEpub = Outside.service(this,"gus06.file.epub.properties.publisher");
