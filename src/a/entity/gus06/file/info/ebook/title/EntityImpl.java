package a.entity.gus06.file.info.ebook.title;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMobi = Outside.service(this,"gus06.file.mobi.properties.title");
		handleEpub = Outside.service(this,"gus06.file.epub.properties.title");
