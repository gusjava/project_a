package a.entity.gus06.file.properties.perform.each.keyvalue.replace;
...
public class EntityImpl implements Entity, P, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		while(it.hasNext())
		{
			...
			String key1 = key.replace(search,replace);
			String value1 = value.replace(search,replace);
