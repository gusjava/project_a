package a.entity.gus06.file.read.string.from.mp3;
...
public class EntityImpl implements Entity, T {
	...
	public static final String PROPKEY = "script.convert.mp3tostring";
	...
	public Object t(Object obj) throws Exception
	{
		...
		throw new Exception("Unsupported operation: reading string from mp3");
