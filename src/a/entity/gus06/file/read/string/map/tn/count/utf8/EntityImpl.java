package a.entity.gus06.file.read.string.map.tn.count.utf8;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		try
		{
			...
			handleLineLazy(line,map);
		}
		catch(Exception e)
		{
			String message = "Failed reading file: "+file;
	...
	private void handleLineLazy(String line, Map map)
	{
		try{handleLine(line,map);}
		catch(Exception e){}
	}
