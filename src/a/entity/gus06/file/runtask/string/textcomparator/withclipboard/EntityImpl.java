package a.entity.gus06.file.runtask.string.textcomparator.withclipboard;
...
public class EntityImpl implements Entity, P {
	...
	public String creationDate() {return "20190618";}
	
	public static final String TITLE = "Text comparator";
	...
	public EntityImpl() throws Exception
	{
		...
		comparatorGui = Outside.service(this,"*gus06.sys.textcomparator1.gui2");
