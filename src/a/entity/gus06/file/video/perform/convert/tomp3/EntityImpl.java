package a.entity.gus06.file.video.perform.convert.tomp3;
...
public class EntityImpl implements Entity, P {
	...
	public static final String PROPKEY = "script.convert.videotomp3";
	...
	public void p(Object obj) throws Exception
	{
		...
		input.put("outputFile",mp3File);
		
		if(!prop.containsKey(PROPKEY))
		throw new Exception("Unsupported operation: converting video to mp3");
