...
public class CasioType2MakernoteDirectory extends Directory
{
	...
	{
		// TODO add names
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_THUMBNAIL_DIMENSIONS), "Thumbnail Dimensions");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_THUMBNAIL_SIZE), "Thumbnail Size");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_THUMBNAIL_OFFSET), "Thumbnail Offset");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_QUALITY_MODE), "Quality Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_IMAGE_SIZE), "Image Size");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_FOCUS_MODE_1), "Focus Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_ISO_SENSITIVITY), "ISO Sensitivity");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_WHITE_BALANCE_1), "White Balance");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_FOCAL_LENGTH), "Focal Length");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_SATURATION), "Saturation");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_CONTRAST), "Contrast");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_CASIO_PREVIEW_THUMBNAIL), "Casio Preview Thumbnail");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_WHITE_BALANCE_BIAS), "White Balance Bias");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_WHITE_BALANCE_2), "White Balance");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_OBJECT_DISTANCE), "Object Distance");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_FLASH_DISTANCE), "Flash Distance");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_RECORD_MODE), "Record Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_SELF_TIMER), "Self Timer");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_QUALITY), "Quality");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_FOCUS_MODE_2), "Focus Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_TIME_ZONE), "Time Zone");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_BESTSHOT_MODE), "BestShot Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_CCD_ISO_SENSITIVITY), "CCD ISO Sensitivity");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_COLOUR_MODE), "Colour Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_ENHANCEMENT), "Enhancement");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_TYPE2_FILTER), "F");
	}
