...
public class ExifDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_FILL_ORDER), "Fill Order");
		tagNameMap.put(Integer.valueOf(TAG_DOCUMENT_NAME), "Document Name");
		tagNameMap.put(Integer.valueOf(0x1000), "Related Image File Format");
		tagNameMap.put(Integer.valueOf(0x1001), "Related Image Width");
		tagNameMap.put(Integer.valueOf(0x1002), "Related Image Length");
		tagNameMap.put(Integer.valueOf(0x0156), "Transfer Range");
		tagNameMap.put(Integer.valueOf(0x0200), "JPEG Proc");
		tagNameMap.put(Integer.valueOf(0x8769), "Exif Offset");
		tagNameMap.put(Integer.valueOf(TAG_COMPRESSION_LEVEL), "Compressed Bits Per Pixel");
		tagNameMap.put(Integer.valueOf(0x927C), "Maker Note");
		tagNameMap.put(Integer.valueOf(0xA005), "Interoperability Offset");

		tagNameMap.put(Integer.valueOf(TAG_NEW_SUBFILE_TYPE), "New Subfile Type");
		tagNameMap.put(Integer.valueOf(TAG_SUBFILE_TYPE), "Subfile Type");
		tagNameMap.put(Integer.valueOf(TAG_THUMBNAIL_IMAGE_WIDTH), "Thumbnail Image Width");
		tagNameMap.put(Integer.valueOf(TAG_THUMBNAIL_IMAGE_HEIGHT), "Thumbnail Image Height");
		tagNameMap.put(Integer.valueOf(TAG_BITS_PER_SAMPLE), "Bits Per Sample");
		tagNameMap.put(Integer.valueOf(TAG_COMPRESSION), "Compression");
		tagNameMap.put(Integer.valueOf(TAG_PHOTOMETRIC_INTERPRETATION), "Photometric Interpretation");
		tagNameMap.put(Integer.valueOf(TAG_THRESHOLDING), "Thresholding");
		tagNameMap.put(Integer.valueOf(TAG_IMAGE_DESCRIPTION), "Image Description");
		tagNameMap.put(Integer.valueOf(TAG_MAKE), "Make");
		tagNameMap.put(Integer.valueOf(TAG_MODEL), "Model");
		tagNameMap.put(Integer.valueOf(TAG_STRIP_OFFSETS), "Strip Offsets");
		tagNameMap.put(Integer.valueOf(TAG_ORIENTATION), "Orientation");
		tagNameMap.put(Integer.valueOf(TAG_SAMPLES_PER_PIXEL), "Samples Per Pixel");
		tagNameMap.put(Integer.valueOf(TAG_ROWS_PER_STRIP), "Rows Per Strip");
		tagNameMap.put(Integer.valueOf(TAG_STRIP_BYTE_COUNTS), "Strip Byte Counts");
		tagNameMap.put(Integer.valueOf(TAG_X_RESOLUTION), "X Resolution");
		tagNameMap.put(Integer.valueOf(TAG_Y_RESOLUTION), "Y Resolution");
		tagNameMap.put(Integer.valueOf(TAG_PAGE_NAME), "Page Name");
		tagNameMap.put(Integer.valueOf(TAG_PLANAR_CONFIGURATION), "Planar Configuration");
		tagNameMap.put(Integer.valueOf(TAG_RESOLUTION_UNIT), "Resolution Unit");
		tagNameMap.put(Integer.valueOf(TAG_TRANSFER_FUNCTION), "Transfer H");
		tagNameMap.put(Integer.valueOf(TAG_SOFTWARE), "Software");
		tagNameMap.put(Integer.valueOf(TAG_DATETIME), "Date/Time");
		tagNameMap.put(Integer.valueOf(TAG_ARTIST), "Artist");
		tagNameMap.put(Integer.valueOf(TAG_PREDICTOR), "Predictor");
		tagNameMap.put(Integer.valueOf(TAG_WHITE_POINT), "White Point");
		tagNameMap.put(Integer.valueOf(TAG_PRIMARY_CHROMATICITIES), "Primary Chromaticities");
		tagNameMap.put(Integer.valueOf(TAG_TILE_WIDTH), "Tile Width");
		tagNameMap.put(Integer.valueOf(TAG_TILE_LENGTH), "Tile Length");
		tagNameMap.put(Integer.valueOf(TAG_TILE_OFFSETS), "Tile Offsets");
		tagNameMap.put(Integer.valueOf(TAG_TILE_BYTE_COUNTS), "Tile Byte Counts");
		tagNameMap.put(Integer.valueOf(TAG_SUB_IFDS), "Sub IFDs");
		tagNameMap.put(Integer.valueOf(TAG_JPEG_TABLES), "JPEG Tables");
		tagNameMap.put(Integer.valueOf(TAG_THUMBNAIL_OFFSET), "Thumbnail Offset");
		tagNameMap.put(Integer.valueOf(TAG_THUMBNAIL_LENGTH), "Thumbnail Length");
		tagNameMap.put(Integer.valueOf(TAG_THUMBNAIL_DATA), "Thumbnail Data");
		tagNameMap.put(Integer.valueOf(TAG_YCBCR_COEFFICIENTS), "YCbCr Coefficients");
		tagNameMap.put(Integer.valueOf(TAG_YCBCR_SUBSAMPLING), "YCbCr Sub-Sampling");
		tagNameMap.put(Integer.valueOf(TAG_YCBCR_POSITIONING), "YCbCr Positioning");
		tagNameMap.put(Integer.valueOf(TAG_REFERENCE_BLACK_WHITE), "Reference Black/White");
		tagNameMap.put(Integer.valueOf(TAG_CFA_REPEAT_PATTERN_DIM), "CFA Repeat Pattern Dim");
		tagNameMap.put(Integer.valueOf(TAG_CFA_PATTERN_2), "CFA Pattern");
		tagNameMap.put(Integer.valueOf(TAG_BATTERY_LEVEL), "Battery Level");
		tagNameMap.put(Integer.valueOf(TAG_COPYRIGHT), "Copyright");
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_TIME), "Exposure Time");
		tagNameMap.put(Integer.valueOf(TAG_FNUMBER), "F-Number");
		tagNameMap.put(Integer.valueOf(TAG_IPTC_NAA), "IPTC/NAA");
		tagNameMap.put(Integer.valueOf(TAG_INTER_COLOR_PROFILE), "Inter Color Profile");
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_PROGRAM), "Exposure Program");
		tagNameMap.put(Integer.valueOf(TAG_SPECTRAL_SENSITIVITY), "Spectral Sensitivity");
		tagNameMap.put(Integer.valueOf(TAG_GPS_INFO), "GPS Info");
		tagNameMap.put(Integer.valueOf(TAG_ISO_EQUIVALENT), "ISO Speed Ratings");
		tagNameMap.put(Integer.valueOf(TAG_OECF), "OECF");
		tagNameMap.put(Integer.valueOf(TAG_INTERLACE), "Interlace");
		tagNameMap.put(Integer.valueOf(TAG_TIME_ZONE_OFFSET), "Time Zone Offset");
		tagNameMap.put(Integer.valueOf(TAG_SELF_TIMER_MODE), "Self Timer Mode");
		tagNameMap.put(Integer.valueOf(TAG_EXIF_VERSION), "Exif Version");
		tagNameMap.put(Integer.valueOf(TAG_DATETIME_ORIGINAL), "Date/Time Original");
		tagNameMap.put(Integer.valueOf(TAG_DATETIME_DIGITIZED), "Date/Time Digitized");
		tagNameMap.put(Integer.valueOf(TAG_COMPONENTS_CONFIGURATION), "Components Configuration");
		tagNameMap.put(Integer.valueOf(TAG_SHUTTER_SPEED), "Shutter Speed Value");
		tagNameMap.put(Integer.valueOf(TAG_APERTURE), "Aperture Value");
		tagNameMap.put(Integer.valueOf(TAG_BRIGHTNESS_VALUE), "Brightness Value");
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_BIAS), "Exposure Bias Value");
		tagNameMap.put(Integer.valueOf(TAG_MAX_APERTURE), "Max Aperture Value");
		tagNameMap.put(Integer.valueOf(TAG_SUBJECT_DISTANCE), "Subject Distance");
		tagNameMap.put(Integer.valueOf(TAG_METERING_MODE), "Metering Mode");
		tagNameMap.put(Integer.valueOf(TAG_WHITE_BALANCE), "Light Source");
		tagNameMap.put(Integer.valueOf(TAG_FLASH), "Flash");
		tagNameMap.put(Integer.valueOf(TAG_FOCAL_LENGTH), "Focal Length");
		tagNameMap.put(Integer.valueOf(TAG_FLASH_ENERGY), "Flash Energy");
		tagNameMap.put(Integer.valueOf(TAG_SPATIAL_FREQ_RESPONSE), "Spatial Frequency Response");
		tagNameMap.put(Integer.valueOf(TAG_NOISE), "Noise");
		tagNameMap.put(Integer.valueOf(TAG_IMAGE_NUMBER), "Image Number");
		tagNameMap.put(Integer.valueOf(TAG_SECURITY_CLASSIFICATION), "Security Classification");
		tagNameMap.put(Integer.valueOf(TAG_IMAGE_HISTORY), "Image History");
		tagNameMap.put(Integer.valueOf(TAG_SUBJECT_LOCATION), "Subject Location");
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_INDEX), "Exposure Index");
		tagNameMap.put(Integer.valueOf(TAG_TIFF_EP_STANDARD_ID), "TIFF/EP Standard ID");
		tagNameMap.put(Integer.valueOf(TAG_USER_COMMENT), "User Comment");
		tagNameMap.put(Integer.valueOf(TAG_SUBSECOND_TIME), "Sub-Sec Time");
		tagNameMap.put(Integer.valueOf(TAG_SUBSECOND_TIME_ORIGINAL), "Sub-Sec Time Original");
		tagNameMap.put(Integer.valueOf(TAG_SUBSECOND_TIME_DIGITIZED), "Sub-Sec Time Digitized");
		tagNameMap.put(Integer.valueOf(TAG_FLASHPIX_VERSION), "FlashPix Version");
		tagNameMap.put(Integer.valueOf(TAG_COLOR_SPACE), "Color Space");
		tagNameMap.put(Integer.valueOf(TAG_EXIF_IMAGE_WIDTH), "Exif Image Width");
		tagNameMap.put(Integer.valueOf(TAG_EXIF_IMAGE_HEIGHT), "Exif Image Height");
		tagNameMap.put(Integer.valueOf(TAG_RELATED_SOUND_FILE), "Related Sound File");
		// 0x920B in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_FLASH_ENERGY_2), "Flash Energy");
		// 0x920C in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_SPATIAL_FREQ_RESPONSE_2), "Spatial Frequency Response");
		// 0x920E in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_FOCAL_PLANE_X_RES), "Focal Plane X Resolution");
		// 0x920F in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_FOCAL_PLANE_Y_RES), "Focal Plane Y Resolution");
		// 0x9210 in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_FOCAL_PLANE_UNIT), "Focal Plane Resolution Unit");
		// 0x9214 in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_SUBJECT_LOCATION_2), "Subject Location");
		// 0x9215 in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_INDEX_2), "Exposure Index");
		// 0x9217 in TIFF/EP
		tagNameMap.put(Integer.valueOf(TAG_SENSING_METHOD), "Sensing Method");
		tagNameMap.put(Integer.valueOf(TAG_FILE_SOURCE), "File Source");
		tagNameMap.put(Integer.valueOf(TAG_SCENE_TYPE), "Scene Type");
		tagNameMap.put(Integer.valueOf(TAG_CFA_PATTERN), "CFA Pattern");

		tagNameMap.put(Integer.valueOf(TAG_CUSTOM_RENDERED), "Custom Rendered");
		tagNameMap.put(Integer.valueOf(TAG_EXPOSURE_MODE), "Exposure Mode");
		tagNameMap.put(Integer.valueOf(TAG_WHITE_BALANCE_MODE), "White Balance");
		tagNameMap.put(Integer.valueOf(TAG_DIGITAL_ZOOM_RATIO), "Digital Zoom Ratio");
		tagNameMap.put(Integer.valueOf(TAG_35MM_FILM_EQUIV_FOCAL_LENGTH), "Focal Length 35");
		tagNameMap.put(Integer.valueOf(TAG_SCENE_CAPTURE_TYPE), "Scene Capture Type");
		tagNameMap.put(Integer.valueOf(TAG_GAIN_CONTROL), "Gain Control");
		tagNameMap.put(Integer.valueOf(TAG_CONTRAST), "Contrast");
		tagNameMap.put(Integer.valueOf(TAG_SATURATION), "Saturation");
		tagNameMap.put(Integer.valueOf(TAG_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_DEVICE_SETTING_DESCRIPTION), "Device Setting Description");
		tagNameMap.put(Integer.valueOf(TAG_SUBJECT_DISTANCE_RANGE), "Subject Distance Range");

		tagNameMap.put(Integer.valueOf(TAG_WIN_AUTHOR), "Windows XP Author");
		tagNameMap.put(Integer.valueOf(TAG_WIN_COMMENT), "Windows XP Comment");
		tagNameMap.put(Integer.valueOf(TAG_WIN_KEYWORDS), "Windows XP Keywords");
		tagNameMap.put(Integer.valueOf(TAG_WIN_SUBJECT), "Windows XP Subject");
		tagNameMap.put(Integer.valueOf(TAG_WIN_TITLE), "Windows XP Title");

		tagNameMap.put(Integer.valueOf(TAG_MIN_SAMPLE_VALUE), "Minimum sample value");
		tagNameMap.put(Integer.valueOf(TAG_MAX_SAMPLE_VALUE), "Maximum sample value");
	}
	...
	public byte[] getThumbnailData() throws Exception
	{
	...
	public void writeThumbnail(String filename) throws Exception, IOException
	{
		byte[] data = getThumbnailData();

		if (data==null)
			throw new Exception("No thumbnail data exists.");
...
/*
	 ...
	 * @throws Exception
	 * /
	public Image getThumbnailImage() throws Exception
	{
		if (!containsThumbnail())
			return null;
...
//			}
	 ...
	 * @return
	 * @throws com.drew.metadata.Exception
	 * /
	private Image createImageFromRawYCbCr(byte[] thumbnailBytes) throws Exception
	{
		/*
...
//		}
	 ...
	 * @throws com.drew.metadata.Exception
	 * /
	private Image createImageFromRawRgb(byte[] thumbnailBytes) throws Exception
	{
