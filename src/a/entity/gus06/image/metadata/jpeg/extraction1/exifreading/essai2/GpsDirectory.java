...
public class GpsDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_GPS_VERSION_ID), "GPS Version ID");
		tagNameMap.put(Integer.valueOf(TAG_GPS_LATITUDE_REF), "GPS Latitude Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_LATITUDE), "GPS Latitude");
		tagNameMap.put(Integer.valueOf(TAG_GPS_LONGITUDE_REF), "GPS Longitude Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_LONGITUDE), "GPS Longitude");
		tagNameMap.put(Integer.valueOf(TAG_GPS_ALTITUDE_REF), "GPS Altitude Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_ALTITUDE), "GPS Altitude");
		tagNameMap.put(Integer.valueOf(TAG_GPS_TIME_STAMP), "GPS Time-Stamp");
		tagNameMap.put(Integer.valueOf(TAG_GPS_SATELLITES), "GPS Satellites");
		tagNameMap.put(Integer.valueOf(TAG_GPS_STATUS), "GPS Status");
		tagNameMap.put(Integer.valueOf(TAG_GPS_MEASURE_MODE), "GPS Measure Mode");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DOP), "GPS DOP");
		tagNameMap.put(Integer.valueOf(TAG_GPS_SPEED_REF), "GPS Speed Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_SPEED), "GPS Speed");
		tagNameMap.put(Integer.valueOf(TAG_GPS_TRACK_REF), "GPS Track Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_TRACK), "GPS Track");
		tagNameMap.put(Integer.valueOf(TAG_GPS_IMG_DIRECTION_REF), "GPS Img Direction Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_IMG_DIRECTION_REF), "GPS Img Direction");
		tagNameMap.put(Integer.valueOf(TAG_GPS_MAP_DATUM), "GPS Map Datum");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_LATITUDE_REF), "GPS Dest Latitude Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_LATITUDE), "GPS Dest Latitude");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_LONGITUDE_REF), "GPS Dest Longitude Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_LONGITUDE), "GPS Dest Longitude");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_BEARING_REF), "GPS Dest Bearing Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_BEARING), "GPS Dest Bearing");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_DISTANCE_REF), "GPS Dest Distance Ref");
		tagNameMap.put(Integer.valueOf(TAG_GPS_DEST_DISTANCE), "GPS Dest Distance");
	}
