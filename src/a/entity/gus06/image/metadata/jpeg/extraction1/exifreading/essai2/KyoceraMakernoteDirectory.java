...
public class KyoceraMakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_KYOCERA_PROPRIETARY_THUMBNAIL), "Proprietary Thumbnail Format Data");
		tagNameMap.put(Integer.valueOf(TAG_KYOCERA_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
	}
