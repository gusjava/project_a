...
public class OlympusMakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_SPECIAL_MODE), "Special Mode");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_JPEG_QUALITY), "Jpeg Quality");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MACRO_MODE), "Macro");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_UNKNOWN_1), "Makernote Unknown 1");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_DIGI_ZOOM_RATIO), "DigiZoom Ratio");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_UNKNOWN_2), "Makernote Unknown 2");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_UNKNOWN_3), "Makernote Unknown 3");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FIRMWARE_VERSION), "Firmware Version");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_PICT_INFO), "Pict Info");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_CAMERA_ID), "Camera Id");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_DATA_DUMP), "Data Dump");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MAKERNOTE_VERSION), "Makernote Version");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_CAMERA_SETTINGS_1), "Camera Settings");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_CAMERA_SETTINGS_2), "Camera Settings");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_COMPRESSED_IMAGE_SIZE), "Compressed Image Size");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MINOLTA_THUMBNAIL_OFFSET_1), "Thumbnail Offset");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MINOLTA_THUMBNAIL_OFFSET_2), "Thumbnail Offset");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MINOLTA_THUMBNAIL_LENGTH), "Thumbnail Length");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_COLOUR_MODE), "Colour Mode");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_IMAGE_QUALITY_1), "Image Quality");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_IMAGE_QUALITY_2), "Image Quality");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_IMAGE_HEIGHT), "Image Height");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_ORIGINAL_MANUFACTURER_MODEL), "Original Manufacturer Model");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FLASH_MODE), "Flash Mode");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_BRACKET), "Bracket");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FOCUS_MODE), "Focus Mode");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FOCUS_DISTANCE), "Focus Distance");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_ZOOM), "Zoom");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_MACRO_FOCUS), "Macro Focus");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_COLOUR_MATRIX), "Colour Matrix");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_BLACK_LEVEL), "Black Level");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_WHITE_BALANCE), "White Balance");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_RED_BIAS), "Red Bias");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_BLUE_BIAS), "Blue Bias");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_SERIAL_NUMBER), "Serial Number");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FLASH_BIAS), "Flash Bias");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_CONTRAST), "Contrast");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_SHARPNESS_FACTOR), "Sharpness Factor");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_COLOUR_CONTROL), "Colour Control");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_VALID_BITS), "Valid Bits");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_CORING_FILTER), "Coring F");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FINAL_WIDTH), "Final Width");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_FINAL_HEIGHT), "Final Height");
		tagNameMap.put(Integer.valueOf(TAG_OLYMPUS_COMPRESSION_RATIO), "Compression Ratio");
	}
