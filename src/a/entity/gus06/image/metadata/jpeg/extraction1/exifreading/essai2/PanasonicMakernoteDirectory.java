...
public class PanasonicMakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_PANASONIC_QUALITY_MODE), "Quality Mode");
		tagNameMap.put(Integer.valueOf(TAG_PANASONIC_VERSION), "Version");
		tagNameMap.put(Integer.valueOf(TAG_PANASONIC_MACRO_MODE), "Macro Mode");
		tagNameMap.put(Integer.valueOf(TAG_PANASONIC_RECORD_MODE), "Record Mode");
		tagNameMap.put(Integer.valueOf(TAG_PANASONIC_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
	}
