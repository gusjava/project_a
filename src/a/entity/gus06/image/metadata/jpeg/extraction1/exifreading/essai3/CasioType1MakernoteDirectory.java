...
public class CasioType1MakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_CASIO_CCD_SENSITIVITY), "CCD Sensitivity");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_CONTRAST), "Contrast");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_DIGITAL_ZOOM), "Digital Zoom");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_FLASH_INTENSITY), "Flash Intensity");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_FLASH_MODE), "Flash Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_FOCUSING_MODE), "Focussing Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_OBJECT_DISTANCE), "Object Distance");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_QUALITY), "Quality");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_RECORDING_MODE), "Recording Mode");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_SATURATION), "Saturation");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_1), "Makernote Unknown 1");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_2), "Makernote Unknown 2");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_3), "Makernote Unknown 3");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_4), "Makernote Unknown 4");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_5), "Makernote Unknown 5");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_6), "Makernote Unknown 6");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_7), "Makernote Unknown 7");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_UNKNOWN_8), "Makernote Unknown 8");
		tagNameMap.put(Integer.valueOf(TAG_CASIO_WHITE_BALANCE), "White Balance");
	}
