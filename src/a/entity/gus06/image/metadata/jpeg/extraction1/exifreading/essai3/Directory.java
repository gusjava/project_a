...
// TAG SETTERS
	...
	public void setObject(int tagType, Object value)
	{
		...
		Integer key = Integer.valueOf(tagType);
...
// TAG GETTERS
	 ...
	 */
	public int getInt(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to int.  It is of type '" + o.getClass() + "'.");
	}
	 ...
	 * @throws Exception if the tag has not been set or cannot be represented
	 *		 as a String[]
	 */
	public String[] getStringArray(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to an String array.  It is of type '" + o.getClass() + "'.");
	}
	 ...
	 * @throws Exception if the tag has not been set, or cannot be converted to
	 *		 an int array
	 */
	public int[] getIntArray(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to an int array.  It is of type '" + o.getClass() + "'.");
	}
	 ...
	 *		 a byte array
	 */
	public byte[] getByteArray(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to a byte array.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a double, if possible.
	 */
	public double getDouble(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
			...
			try {
				...
				throw new Exception("unable to parse string " + o + " as a double", nfe);
			}
		} else if (o instanceof Number) {
			return ((Number)o).doubleValue();
		}
		throw new Exception("Tag '" + tagType + "' cannot be cast to a double.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a float, if possible.
	 */
	public float getFloat(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
			...
			try {
				...
				throw new Exception("unable to parse string " + o + " as a float", nfe);
			}
		} else if (o instanceof Number) {
			return ((Number)o).floatValue();
		}
		throw new Exception("Tag '" + tagType + "' cannot be cast to a float.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a long, if possible.
	 */
	public long getLong(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
			...
			try {
				...
				throw new Exception("unable to parse string " + o + " as a long", nfe);
			}
		} else if (o instanceof Number) {
			return ((Number)o).longValue();
		}
		throw new Exception("Tag '" + tagType + "' cannot be cast to a long.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a boolean, if possible.
	 */
	public boolean getBoolean(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
			...
			try {
				...
				throw new Exception("unable to parse string " + o + " as a boolean", nfe);
			}
		} else if (o instanceof Number) {
			return (((Number)o).doubleValue()!=0);
		}
		throw new Exception("Tag '" + tagType + "' cannot be cast to a boolean.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a java.util.Date, if possible.
	 */
	public java.util.Date getDate(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to a java.util.Date.  It is of type '" + o.getClass() + "'.");
	}

	/**
	 * Returns the specified tag's value as a Rational, if possible.
	 */
	public Rational getRational(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to a Rational.  It is of type '" + o.getClass() + "'.");
	}

	public Rational[] getRationalArray(int tagType) throws Exception
	{
		Object o = getObject(tagType);
		if (o==null) {
			throw new Exception("Tag " + getTagName(tagType) + " has not been set -- check using containsTag() first");
		...
		throw new Exception("Tag '" + tagType + "' cannot be cast to a Rational array.  It is of type '" + o.getClass() + "'.");
	}
...
// OTHER METHODS
	 ...
	 * @throws Exception if a descriptor hasn't been set, or if an error
	...
	{
		if (_descriptor==null) {
			throw new Exception("a descriptor must be set using setDescriptor(...) before descriptions can be provided");
		}
