...
public class ExifDescriptor extends TagDescriptor
{
	 ...
	 */
	public String getDescription(int tagType) throws Exception
	{
		switch (tagType) {
	...
	public String getNewSubfileTypeDescription() throws Exception
	{
	...
	public String getSubfileTypeDescription() throws Exception
	{
	...
	public String getThresholdingDescription() throws Exception
	{
	...
	public String getFillOrderDescription() throws Exception
	{
	...
	public String getSubjectDistanceRangeDescription() throws Exception
	{
	...
	public String getSharpnessDescription() throws Exception
	{
	...
	public String getSaturationDescription() throws Exception
	{
	...
	public String getContrastDescription() throws Exception
	{
	...
	public String getGainControlDescription() throws Exception
	{
	...
	public String getSceneCaptureTypeDescription() throws Exception
	{
	...
	public String get35mmFilmEquivFocalLengthDescription() throws Exception
	{
	...
	public String getDigitalZoomRatioDescription() throws Exception
	{
	...
	public String getWhiteBalanceModeDescription() throws Exception
	{
	...
	public String getExposureModeDescription() throws Exception
	{
	...
	public String getCustomRenderedDescription() throws Exception
	{
	...
	public String getUserCommentDescription() throws Exception
	{
	...
	public String getThumbnailDescription() throws Exception
	{
	...
	public String getIsoEquivalentDescription() throws Exception
	{
	...
	public String getReferenceBlackWhiteDescription() throws Exception
	{
	...
	public String getExifVersionDescription() throws Exception
	{
	...
	public String getFlashPixVersionDescription() throws Exception
	{
	...
	public String getSceneTypeDescription() throws Exception
	{
	...
	public String getFileSourceDescription() throws Exception
	{
	...
	public String getExposureBiasDescription() throws Exception
	{
	...
	public String getMaxApertureValueDescription() throws Exception
	{
	...
	public String getApertureValueDescription() throws Exception
	{
	...
	public String getExposureProgramDescription() throws Exception
	{
	...
	public String getYCbCrSubsamplingDescription() throws Exception
	{
	...
	public String getPlanarConfigurationDescription() throws Exception
	{
	...
	public String getPhotometricInterpretationDescription() throws Exception
	{
		...
		switch (_directory.getInt(ExifDirectory.TAG_PHOTOMETRIC_INTERPRETATION)) {
			...
			case 32803: return "Color F Array";
	...
	public String getCompressionDescription() throws Exception
	{
	...
	public String getFocalPlaneXResolutionDescription() throws Exception
	{
	...
	public String getFocalPlaneYResolutionDescription() throws Exception
	{
	...
	public String getFocalPlaneResolutionUnitDescription() throws Exception
	{
	...
	public String getExifImageWidthDescription() throws Exception
	{
	...
	public String getExifImageHeightDescription() throws Exception
	{
	...
	public String getColorSpaceDescription() throws Exception
	{
	...
	public String getFocalLengthDescription() throws Exception
	{
	...
	public String getFlashDescription() throws Exception
	{
	...
	public String getWhiteBalanceDescription() throws Exception
	{
	...
	public String getMeteringModeDescription() throws Exception
	{
	...
	public String getSubjectDistanceDescription() throws Exception
	{
	...
	public String getCompressionLevelDescription() throws Exception
	{
	...
	public String getYResolutionDescription() throws Exception
	{
	...
	public String getXResolutionDescription() throws Exception
	{
	...
	public String getShutterSpeedDescription() throws Exception
	{
...
*/
	...
	public String getFNumberDescription() throws Exception
	{
	...
	public String getYCbCrPositioningDescription() throws Exception
	{
	...
	public String getOrientationDescription() throws Exception
	{
	...
	public String getResolutionDescription() throws Exception
	{
	...
	public String getSensingMethodDescription() throws Exception
	{
	...
	public String getComponentConfigurationDescription() throws Exception
	{
	 ...
	 */
	private String getUnicodeDescription(int tag) throws Exception
	{
	...
	public String getWindowsAuthorDescription() throws Exception
	{
	   return getUnicodeDescription(ExifDirectory.TAG_WIN_AUTHOR);
	}

	public String getWindowsCommentDescription() throws Exception
	{
	   return getUnicodeDescription(ExifDirectory.TAG_WIN_COMMENT);
	}

	public String getWindowsKeywordsDescription() throws Exception
	{
	   return getUnicodeDescription(ExifDirectory.TAG_WIN_KEYWORDS);
	}

	public String getWindowsTitleDescription() throws Exception
	{
	   return getUnicodeDescription(ExifDirectory.TAG_WIN_TITLE);
	}

	public String getWindowsSubjectDescription() throws Exception
	{
