...
public class ExifInteropDirectory extends Directory
{
	...
	static
	{
		...
		tagNameMap.put(Integer.valueOf(TAG_INTEROP_INDEX), "Interoperability Index");
		tagNameMap.put(Integer.valueOf(TAG_INTEROP_VERSION), "Interoperability Version");
		tagNameMap.put(Integer.valueOf(TAG_RELATED_IMAGE_FILE_FORMAT), "Related Image File Format");
		tagNameMap.put(Integer.valueOf(TAG_RELATED_IMAGE_WIDTH), "Related Image Width");
		tagNameMap.put(Integer.valueOf(TAG_RELATED_IMAGE_LENGTH), "Related Image Length");
	}
