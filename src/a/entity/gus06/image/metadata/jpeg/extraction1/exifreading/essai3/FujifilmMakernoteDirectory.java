...
public class FujifilmMakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_AE_WARNING), "AE Warning");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_BLUR_WARNING), "Blur Warning");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_COLOR), "Color");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_CONTINUOUS_TAKING_OR_AUTO_BRACKETTING), "Continuous Taking Or Auto Bracketting");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_FLASH_MODE), "Flash Mode");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_FLASH_STRENGTH), "Flash Strength");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_FOCUS_MODE), "Focus Mode");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_FOCUS_WARNING), "Focus Warning");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_MACRO), "Macro");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_MAKERNOTE_VERSION), "Makernote Version");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_PICTURE_MODE), "Picture Mode");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_QUALITY), "Quality");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_SLOW_SYNCHRO), "Slow Synchro");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_TONE), "Tone");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_UNKNOWN_1), "Makernote Unknown 1");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_UNKNOWN_2), "Makernote Unknown 2");
		tagNameMap.put(Integer.valueOf(TAG_FUJIFILM_WHITE_BALANCE), "White Balance");
	}
