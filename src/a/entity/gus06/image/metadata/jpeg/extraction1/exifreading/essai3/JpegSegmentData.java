...
public class JpegSegmentData implements Serializable
{
	...
	{
		final List segmentList = (List)_segmentDataMap.get(Byte.valueOf(segmentMarker));
	...
	{
		return (List)_segmentDataMap.get(Byte.valueOf(segmentMarker));
	}

	private List getOrCreateSegmentList(byte segmentMarker)
	{
		List segmentList;
		Byte key = Byte.valueOf(segmentMarker);
