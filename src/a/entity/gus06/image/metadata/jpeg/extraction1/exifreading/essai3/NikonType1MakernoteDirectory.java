...
public class NikonType1MakernoteDirectory extends Directory
{
	...
	static
	{
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_CCD_SENSITIVITY), "CCD Sensitivity");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_COLOR_MODE), "Color Mode");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_DIGITAL_ZOOM), "Digital Zoom");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_CONVERTER), "Fisheye Converter");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_FOCUS), "Focus");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_IMAGE_ADJUSTMENT), "Image Adjustment");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_QUALITY), "Quality");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_UNKNOWN_1), "Makernote Unknown 1");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_UNKNOWN_2), "Makernote Unknown 2");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_UNKNOWN_3), "Makernote Unknown 3");
		_tagNameMap.put(Integer.valueOf(TAG_NIKON_TYPE1_WHITE_BALANCE), "White Balance");
	}
