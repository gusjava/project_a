...
public class PentaxMakernoteDirectory extends Directory
{
	...
	static
	{
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_CAPTURE_MODE), "Capture Mode");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_QUALITY_LEVEL), "Quality Level");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_FOCUS_MODE), "Focus Mode");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_FLASH_MODE), "Flash Mode");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_WHITE_BALANCE), "White Balance");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_DIGITAL_ZOOM), "Digital Zoom");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_SHARPNESS), "Sharpness");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_CONTRAST), "Contrast");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_SATURATION), "Saturation");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_ISO_SPEED), "ISO Speed");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_COLOUR), "Colour");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_TIME_ZONE), "Time Zone");
		tagNameMap.put(Integer.valueOf(TAG_PENTAX_DAYLIGHT_SAVINGS), "Daylight Savings");
	}
