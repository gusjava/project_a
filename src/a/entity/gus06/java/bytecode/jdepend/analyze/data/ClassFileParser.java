...
import java.util.*;
	...
	/*
	 * magic			4 This identifies the .class file format. It should be 0xCAFEBABE. If ites anything else, youere dealing with a format more recent than this book.
	 ...
	 * this class	   2 This tells you which entry in the constant pool holds this classes class info.
	 * superclass	   2 If this is zero, then this classes only superclass is java.lang.Object. Otherwise, this is an index into the constant pool for the superclass class info.
	 * interfaces	   variable
	 * 
...
public class ClassFileParser {
	...
	private class Constant
	{
		...
		public Constant() throws Exception
		{
			...
			case (CONSTANT_INTEGER):			init(Integer.valueOf(_int()));break;
			case (CONSTANT_FLOAT):			    init(Float.valueOf(_float()));break;
			case (CONSTANT_LONG):			    init(Long.valueOf(_long()));break;
			case (CONSTANT_DOUBLE):			    init(Double.valueOf(_double()));break;
