package a.entity.gus06.java.compiler.v3;
...
public class EntityImpl implements Entity, E, V {
	...
	public EntityImpl() throws Exception
	{
		...
		handleProcess = Outside.service(this,"gus06.java.compiler.v3.handleprocess");
		buildListing = Outside.service(this,"gus06.java.compiler.v3.buildlisting");
		handleOther = Outside.service(this,"gus06.java.compiler.v3.handleotherfiles");
	...
	public void e() throws Exception
	{
		...
		Process pr = pb.start();
		handleProcess.p(new Object[]{pr,out,cmd,listingFile});
		
		if(filter==null) completeBin();
	}
	...
	{
		return (File) buildListing.t(new Object[]{srcDir,binDir,filter});
	}
