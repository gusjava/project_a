package a.entity.gus06.java.srccode.entity.parser;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		getCreationDate = Outside.service(this,"gus06.java.srccode.entity.parser.creationdate");
	}
	...
	public Object t(Object obj) throws Exception
	{
		try
		{
			...
			String creationDate = (String) getCreationDate.t(creationDateMethodBody);
			if(creationDate==null) return null;
			
			String entityName = package1.substring(13);
			
			List features = new ArrayList();
			if(interfaces.contains("E")) features.add("E");
			if(interfaces.contains("G")) features.add("G");
			if(interfaces.contains("P")) features.add("P");
			if(interfaces.contains("T")) features.add("T");
			if(interfaces.contains("F")) features.add("F");
			if(interfaces.contains("H")) features.add("H");
			if(interfaces.contains("R")) features.add("R");
			if(interfaces.contains("V")) features.add("V");
			if(interfaces.contains("I")) features.add("I");
			if(interfaces.contains("S")) features.add("S");
			if(extends1.contains("S1")) features.add("S");
			
			Map output = new HashMap();
			output.put("entityname", entityName);
			output.put("creationDate", creationDate);
