package a.entity.gus06.jdbc.generic.perform.db.emptytables;
...
public class EntityImpl implements Entity, P {
	...
	{
		handleMysql = Outside.service(this,"gus06.jdbc.mysql.perform.db.emptytables");
		handlePostgresql = Outside.service(this,"gus06.jdbc.postgresql.perform.db.emptytables");
	}
