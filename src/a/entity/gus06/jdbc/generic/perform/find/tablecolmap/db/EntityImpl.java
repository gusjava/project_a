package a.entity.gus06.jdbc.generic.perform.find.tablecolmap.db;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMysql = Outside.service(this,"gus06.jdbc.mysql.perform.find.tablecolmap.db");
		handlePostgresql = Outside.service(this,"gus06.jdbc.postgresql.perform.find.tablecolmap.db");
		handleH2 = Outside.service(this,"gus06.jdbc.h2.perform.find.tablecolmap.db");
	}
