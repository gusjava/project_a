package a.entity.gus06.jdbc.generic.perform.find.variablemap;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMysql = Outside.service(this,"gus06.jdbc.mysql.perform.find.variablemap");
		handlePostgresql = Outside.service(this,"gus06.jdbc.postgresql.perform.find.variablemap");
	}
