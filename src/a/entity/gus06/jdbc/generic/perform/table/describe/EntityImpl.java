package a.entity.gus06.jdbc.generic.perform.table.describe;
...
public class EntityImpl implements Entity, T {
	...
	{
		handleMysql = Outside.service(this,"gus06.jdbc.mysql.perform.table.describe");
		handlePostgresql = Outside.service(this,"gus06.jdbc.postgresql.perform.table.describe");
		handleH2 = Outside.service(this,"gus06.jdbc.h2.perform.table.describe");
	}
