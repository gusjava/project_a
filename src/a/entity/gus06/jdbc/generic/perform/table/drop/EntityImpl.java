package a.entity.gus06.jdbc.generic.perform.table.drop;
...
public class EntityImpl implements Entity, P {
	...
	{
		handleMysql = Outside.service(this,"gus06.jdbc.mysql.perform.table.drop");
		handlePostgresql = Outside.service(this,"gus06.jdbc.postgresql.perform.table.drop");
	}
