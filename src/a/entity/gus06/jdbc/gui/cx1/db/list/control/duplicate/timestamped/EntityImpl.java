package a.entity.gus06.jdbc.gui.cx1.db.list.control.duplicate.timestamped;
...
public class EntityImpl implements Entity, F {
	...
	public EntityImpl() throws Exception
	{
		...
		format = Outside.service(this,"gus06.string.transform.timestamp.update.tail");
	}
	...
	public boolean f(Object obj) throws Exception
	{
		...
		for(int i=0;i<selection.size();i++)
		{
			...
			String newDbName = format(dbName);
