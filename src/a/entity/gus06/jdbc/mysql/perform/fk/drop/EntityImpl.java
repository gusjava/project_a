package a.entity.gus06.jdbc.mysql.perform.fk.drop;
...
public class EntityImpl implements Entity, P {
	...
	{
		buildSql = Outside.service(this,"gus06.jdbc.mysql.sql.foreignkey.drop");
	...
	public void p(Object obj) throws Exception
	{
		...
		String sql = (String) buildSql.t(new Object[]{path,fkName});
