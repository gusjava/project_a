package a.entity.gus06.jdbc.mysql.perform.fk.map2.db;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.perform.fk.full.db");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		for(int i=0;i<list.size();i++)
		{
			...
			map.put(key, new String[]{ref, constraintName});
		}
		return map;
	}
