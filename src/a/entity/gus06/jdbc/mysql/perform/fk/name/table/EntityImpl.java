package a.entity.gus06.jdbc.mysql.perform.fk.name.table;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildSql = Outside.service(this,"gus06.jdbc.mysql.sql.info.fk.name.table");
		rsToList = Outside.service(this,"gus06.jdbc.resultset.tostringlist");
	}
