package a.entity.gus06.map.build.sortedvalues.t.inv;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		List values = new ArrayList(input.values());
		Collections.sort(values,new Comparator1(trans));
		return values;
	}
	...
	private class Comparator1 implements Comparator
	{
		...
		{
			Comparable r1 = (Comparable) trans(t,value1);
			Comparable r2 = (Comparable) trans(t,value2);
