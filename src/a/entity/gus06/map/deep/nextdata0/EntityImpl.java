package a.entity.gus06.map.deep.nextdata0;
...
public class EntityImpl implements Entity, T {
	...
	{
		map = Outside.service(this,"gus06.map.deep.nextdata0.map");
		list = Outside.service(this,"gus06.map.deep.nextdata0.list");
		set = Outside.service(this,"gus06.map.deep.nextdata0.set");
