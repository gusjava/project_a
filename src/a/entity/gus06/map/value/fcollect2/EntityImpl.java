package a.entity.gus06.map.value.fcollect2;
...
public class EntityImpl implements Entity, P, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		while(it.hasNext())
		{
			...
			output.put(field,t.t(new Object[]{field,value,input}));
		...
		if(defaultRule!=null)
		{
			...
			while(it.hasNext())
			{
				...
				output.put(field,defaultRule.t(new Object[]{field,value,input}));
			}
		}
		return output;
	}
