...
public abstract class AbstractSearch4 extends S1 implements V, R, Runnable {
	...
	protected boolean isEnd2(int[] p)
	{
		for(int[] e:ends2)
			if(equals(e,p)) return true;
		return false;
	...
	public Object r(String key) throws Exception
	{
		...
		if(key.equals("keys")) return new String[]{"path","paths","current","state"};
		throw new Exception("Unknown key: "+key);
	}
	...
	protected int[][] pathAt(int index)
	{return (int[][]) paths.get(index);}
