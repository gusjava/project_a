package a.entity.gus06.math.perfectsqr.array.until10000;

import a.framework.*;

public class EntityImpl implements Entity, G, F, T {

	public String creationDate() {return "20231107";}

	public static final int[] SQUARES = new int[]{
	...
	public boolean f(Object obj) throws Exception
	{
		...
		for(int square : SQUARES) if(n==square) return true;
		return false;
	}
	...
	{
		int n = Integer.parseInt(""+obj);
		for(int square : SQUARES) if(n==square) return square;
		return null;
	}
}