package a.entity.gus06.string.extract.date1.regex;
...
public class EntityImpl implements Entity, G {
	...
	public static final String REGEX2 = REGEX_YEAR2+"-"+REGEX_MONTH+"-"+REGEX_DAY; //aaaa-mm-jj
	public static final String REGEX3 = REGEX_DAY+" "+REGEX_MONTH_L+" "+REGEX_YEAR2; //jj mm aaaa
	
	// regex
	
	public static final String REGEX = "("+REGEX1+")|("+REGEX2+")|("+REGEX3+")";
