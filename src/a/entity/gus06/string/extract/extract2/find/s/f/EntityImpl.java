package a.entity.gus06.string.extract.extract2.find.s.f;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildPattern = Outside.service(this,"gus06.string.extract.extract2.pattern");
		perform = Outside.service(this,"gus06.string.extract.match.first.g1");
	}
