package a.entity.gus06.string.transform.japanese.katakana.builder;

import a.framework.*;
import java.util.HashMap;
import java.util.Map;

public class EntityImpl extends CodePointsKatakana implements Entity, T, G {
