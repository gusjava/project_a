package a.entity.gus06.swing.combobox.build.icon.language.jp;
...
public class EntityImpl implements Entity, I {
	...
	public EntityImpl() throws Exception
	{
		...
		iconProvider = Outside.service(this,"gus06.icon.provider.flag");
	}
	
	public Object i() throws Exception
	{
		Map map = (Map) buildMap.t(Locale.JAPANESE);
