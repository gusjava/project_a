package a.entity.gus06.swing.comp.cust3.execute.ctrl_a;
...
public class EntityImpl implements Entity, P {
	...
	public String creationDate() {return "20250305";}
	...
	private class Holder implements KeyListener, MouseListener
	{
		...
		{if(evt.isControlDown() && evt.getKeyCode()==KeyEvent.VK_A) execute(ex);}
