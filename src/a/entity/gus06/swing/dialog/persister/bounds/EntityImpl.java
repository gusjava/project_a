package a.entity.gus06.swing.dialog.persister.bounds;
...
public class EntityImpl implements Entity, V {
	...
	public EntityImpl() throws Exception
	{
		...
		dialogToInfo = Outside.service(this,"gus06.swing.dialog.dialogtobounds");
		infoToDialog = Outside.service(this,"gus06.swing.dialog.cust2.bounds");
	}
	...
	private void custDialog(String text, JDialog comp)
	{
		...
		{Outside.err(this,"custDialog(String,Dialog)",e);}
	}
}
