package a.entity.gus06.swing.panel.cust.layout.flatting2;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception
	{
		...
		new PanelHolder_Border(panel,(BorderLayout)layout);
	}
	
	
	private class PanelHolder_Border implements ComponentListener
	{
		...
		public PanelHolder_Border(JPanel panel, BorderLayout layout) throws Exception
		{
			this.panel = panel;
			this.layout = layout;
