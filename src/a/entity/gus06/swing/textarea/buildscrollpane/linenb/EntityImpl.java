package a.entity.gus06.swing.textarea.buildscrollpane.linenb;
...
//			BoundedRangeModel model = (BoundedRangeModel)getVerticalScrollBar().getModel();
//            		Point p = getRowHeader().getViewPosition();
//	            	p.y = model.getValue();
