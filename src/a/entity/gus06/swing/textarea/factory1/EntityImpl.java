package a.entity.gus06.swing.textarea.factory1;
...
public class EntityImpl implements Entity, I {
	...
	{
		documentFactory = Outside.service(this,"gus06.swing.textarea.plaindocument.factory1");
		undoableDelayBuilder = Outside.service(this,"gus06.swing.textarea.plaindocument.undoable.delaybuilder");
	}
	...
	private class JTextArea1 extends JTextArea implements P, V, R
	{
		...
		public void v(String key, Object obj) throws Exception
		{
			...
			if(key.equals("tooltipBuilder")) {tooltipBuilder = (G) obj;return;}
		...
		{
			if(tooltipBuilder==null) return super.createToolTip();
			return buildToolTip(tooltipBuilder);
		}
	...
	private JToolTip buildToolTip(G builder)
	{
		try{return (JToolTip) builder.g();}
		catch(Exception e)
		{Outside.err(this,"buildToolTip(G)",e);}
		return null;
	}
}
