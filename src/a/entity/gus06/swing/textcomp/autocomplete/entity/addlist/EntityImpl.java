package a.entity.gus06.swing.textcomp.autocomplete.entity.addlist;
...
public class EntityImpl implements Entity, P, V {
	...
	public static final String NEW1 = "new ArrayList()";
	public static final String TYPE = "List";
	
	public static final String IMPORT1 = "java.util.List";
	public static final String IMPORT2 = "java.util.ArrayList";
	public static final String DEFAULT_VARNAME = "list";
	...
	public void v(String key, Object obj) throws Exception
	{
		...
		if(key.toLowerCase().equals("g"))
		{handle(comp, DEFAULT_VARNAME, true);return;}
		
		String[] n = key.split(" +", 2);
		String varName = n[0];
		String options = n.length==2 ? n[1] : "";
		boolean featureG = options.toLowerCase().equals("g");
		
		handle(comp, varName, featureG);
	}
	
	
	private void handle(JTextComponent comp, String varName, boolean featureG) throws Exception
	{
		addCons.p(comp);
		addImport.v(IMPORT1,comp);
		addImport.v(IMPORT2,comp);
		
		if(featureG) addFeature.v("g", comp);
		...
		for(int i=0;i<lines.length;i++)
		{
			...
			if(featureG && line.trim().equals("public Object g() throws Exception"))
			pos3 = i+1;
		}
