package a.entity.gus06.swing.textcomp.autocomplete.entity.addmap;
...
public class EntityImpl implements Entity, P, V {
	...
	public static final String NEW1 = "new HashMap()";
	public static final String TYPE = "Map";
	
	public static final String IMPORT1 = "java.util.Map";
	public static final String IMPORT2 = "java.util.HashMap";
	public static final String DEFAULT_VARNAME = "map";
