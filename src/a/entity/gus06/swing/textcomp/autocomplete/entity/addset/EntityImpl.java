package a.entity.gus06.swing.textcomp.autocomplete.entity.addset;
...
public class EntityImpl implements Entity, P, V {
	...
	public static final String NEW1 = "new HashSet()";
	public static final String TYPE = "Set";
	
	public static final String IMPORT1 = "java.util.Set";
	public static final String IMPORT2 = "java.util.HashSet";
	public static final String DEFAULT_VARNAME = "set";
