package a.entity.gus06.swing.textcomp.cust.action.ctrl_b.execute.perform;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY_HANDLER = "ctrl_b_handler";
	...
	{
		perform2 = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_b.execute.perform2");
		perform3 = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_b.execute.perform3");
	...
	public void p(Object obj) throws Exception
	{
		if(obj instanceof JTextArea)
		{
			...
			else perform2.p(new Object[]{comp,text});
		}
	}
