package a.entity.gus06.swing.textcomp.cust.action.ctrl_down.select.after;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_down.select.after.perform");
