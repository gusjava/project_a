package a.entity.gus06.swing.textcomp.cust.action.ctrl_e.doubleline.perform;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY_HANDLER = "ctrl_e_handler";
	...
	public EntityImpl() throws Exception
	{
		...
		selectionMono = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_e.doubleline.perform.selection.mono");
		selectionMulti = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_e.doubleline.perform.selection.multi");
		caret = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_e.doubleline.perform.caret");
	}
