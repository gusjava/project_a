package a.entity.gus06.swing.textcomp.cust.action.ctrl_right.select.forward;
...
public class EntityImpl implements Entity, P {
	...
	public static final String DEFAULT_KEY = "ctrl right";
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_right.select.forward.perform");
