package a.entity.gus06.swing.textcomp.cust.action.ctrl_shift_f.search.perform;
...
public class EntityImpl implements Entity, P {
	...
	public static final String KEY_HANDLER = "ctrl_shift_f_handler";
	...
	private void perform(JTextComponent comp) throws Exception
	{
		...
		Pattern p = Pattern.compile(Pattern.quote(exp),Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
