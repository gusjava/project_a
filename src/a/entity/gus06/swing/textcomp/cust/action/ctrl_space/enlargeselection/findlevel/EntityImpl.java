package a.entity.gus06.swing.textcomp.cust.action.ctrl_space.enlargeselection.findlevel;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(selection==null) return SELECTION_EMPTY;
		if(start==end) return SELECTION_EMPTY;
		if(start==0 && end==text.length()) return SELECTION_ALL;

		if(selection.matches("[a-zA-Z0-9_\\.#]+"))
		{
			if(selection.contains("#")) return SELECTION_WORD4;
			if(selection.contains(".")) return SELECTION_WORD3;
			if(selection.contains("_")) return SELECTION_WORD2;
