package a.entity.gus06.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p0;
...
public class EntityImpl implements Entity, P {
	...
	{
		performMore = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p1");
		buildDelim = Outside.service(this,"gus06.string.split.words1.delim");
	...
	public void p(Object obj) throws Exception
	{
		...
		if(start==end-1) performMore.p(comp);
