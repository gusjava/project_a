package a.entity.gus06.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p2;
...
public class EntityImpl implements Entity, P {
	...
	{
		performMore = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p3");
		buildDelim = Outside.service(this,"gus06.string.split.words2.delim");
