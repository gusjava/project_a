package a.entity.gus06.swing.textcomp.cust.action.ctrl_up.select.before;
...
public class EntityImpl implements Entity, P {
	...
	public static final String DEFAULT_KEY = "ctrl up";
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_up.select.before.perform");
