package a.entity.gus06.swing.textcomp.cust.action.del;
...
public class EntityImpl implements Entity, P {
	...
	public static final KeyStroke KEYSTROKE = KeyStroke.getKeyStroke(KeyEvent.VK_DELETE,0);
	
	
	private Service perform;
	
	public EntityImpl() throws Exception
	{perform = Outside.service(this,"gus06.swing.textcomp.cust.action.del.perform");}
