package a.entity.gus06.swing.textcomp.cust.action.f1.autocomplete;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.action.f1.autocomplete.perform");
