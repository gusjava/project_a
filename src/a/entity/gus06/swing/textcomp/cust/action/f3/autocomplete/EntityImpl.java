package a.entity.gus06.swing.textcomp.cust.action.f3.autocomplete;
...
public class EntityImpl implements Entity, P {
	...
	public static final String DEFAULT_KEY = "f3";
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.action.f3.autocomplete.perform");
