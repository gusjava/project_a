package a.entity.gus06.swing.textcomp.cust.autoedit.enter1;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform = Outside.service(this,"gus06.swing.textcomp.cust.autoedit.enter1.perform");
	}
	...
	private void perform(JTextComponent comp, KeyEvent evt)
	{
		try
		{
			...
			switch(code)
			{
				case KeyEvent.VK_ENTER: perform.p(comp);break;
			}
		}
		catch(Exception e)
