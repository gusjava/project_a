...
public class JavaToken extends Token {
	...
	public boolean isReservedWord(){return (ID >> 8) == 0x1;}
	public boolean isIdentifier(){return (ID >> 8) == 0x2;}
	public boolean isLiteral(){return (ID >> 8) == 0x3;}
	public boolean isSeparator(){return (ID >> 8) == 0x4;}
	public boolean isOperator(){return (ID >> 8) == 0x5;}
	public boolean isComment(){return (ID >> 8) == 0xD;}
	public boolean isWhiteSpace(){return (ID >> 8) == 0xE;}
	public boolean isError(){return (ID >> 8) == 0xF;}


	public String getDescription()
	{
		if(isReservedWord()) return("reservedWord");
	...
	public String errorString()
	{
		...
		String s = "Error on line "+lineNumber+": ";
		switch(ID)
		{
		case ERROR_IDENTIFIER:s += "Unrecognized Identifier: "+contents;break; 
		case ERROR_UNCLOSED_STRING:s += "'\"' expected after "+contents;break;         
		case ERROR_MALFORMED_STRING:
		case ERROR_MALFORMED_UNCLOSED_STRING:s += "Illegal character in "+contents;break;
		case ERROR_UNCLOSED_CHARACTER:s += "\"'\" expected after "+contents;break;         
		case ERROR_MALFORMED_CHARACTER:
		case ERROR_MALFORMED_UNCLOSED_CHARACTER:s += "Illegal character in "+contents;break;
		case ERROR_INTEGER_DECIMIAL_SIZE:
		case ERROR_INTEGER_OCTAL_SIZE:
		case ERROR_FLOAT:s += "Illegal character in "+contents;break;
		...
		case ERROR_DOUBLE_SIZE:s += "Literal out of bounds: " + contents;break;
		case ERROR_UNCLOSED_COMMENT:s += "*/ expected after " + contents;break;
		}
	...
	public String toString()
	{
		return "Token #"+Integer.toHexString(ID)+": "+getDescription()+
				" Line "+lineNumber+" from "+charBegin+" to "+charEnd+" : "+contents;
	}
}
