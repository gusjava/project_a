 ...
 */ 
public class SQLToken1 extends Token {
  /**
   ...
   */
  public SQLToken1(int ID, String contents, int lineNumber, int charBegin, int charEnd){
   ...
   */
  public SQLToken1(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
	this.ID = ID;
