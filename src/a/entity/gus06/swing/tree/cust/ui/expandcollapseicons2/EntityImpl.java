package a.entity.gus06.swing.tree.cust.ui.expandcollapseicons2;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		icon_col1 = icon("TREE_collapsedState1");
		icon_exp1 = icon("TREE_expandedState1");
		icon_col2 = icon("TREE_collapsedState2");
		icon_exp2 = icon("TREE_expandedState2");
	}
