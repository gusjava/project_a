package a.entity.gus06.swing.tree.perform.file.gotoright;
...
public class EntityImpl implements Entity, P, F {
	...
	public boolean f(Object obj) throws Exception
	{
		...
		String goToPath = findNext(search,path);
	...
	private String findNext(Map search, String path) throws Exception
	{
