package a.entity.gus06.sys.chessgame1.gui.board;
...
public class EntityImpl extends S1 implements Entity, I, P, G, V, MouseListener, MouseMotionListener {
	...
	private T findIcon;
	private Color colorDark = Color.LIGHT_GRAY;
	...
	{
		if(key.equals("findIcon")) {findIcon = (T) obj;return;}
		if(key.equals("colorLight")) {colorLight = (Color) obj;return;}
		if(key.equals("colorDark")) {colorDark = (Color) obj;return;}
	...
	{
		int sum = row+column;
		return sum%2==0?colorLight:colorDark;
	}
