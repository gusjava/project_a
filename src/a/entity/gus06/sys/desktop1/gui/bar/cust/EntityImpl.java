package a.entity.gus06.sys.desktop1.gui.bar.cust;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		buildActionAddItem = Outside.service(this,"gus06.sys.desktop1.action.item.add");
		buildActionRemoveItem = Outside.service(this,"gus06.sys.desktop1.action.item.remove");
		buildActionCustItem = Outside.service(this,"gus06.sys.desktop1.action.item.customize");
	}
