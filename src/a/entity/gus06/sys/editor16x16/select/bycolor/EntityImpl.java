package a.entity.gus06.sys.editor16x16.select.bycolor;
...
public class EntityImpl implements Entity, F {
	...
	{
		fromClipboard = Outside.service(this,"gus06.sys.editor16x16.select.bycolor.clipboard");
	}
	...
	public boolean f(Object obj) throws Exception
	{
		...
		if(selection.isEmpty())
			return fromClipboard.f(new Object[]{data, selection});
