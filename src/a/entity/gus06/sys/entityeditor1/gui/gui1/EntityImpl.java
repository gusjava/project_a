package a.entity.gus06.sys.entityeditor1.gui.gui1;
...
public class EntityImpl implements Entity, I, P, ActionListener {
	...
	{
		guiList = Outside.service(this, "*gus.sys.entityeditor1.gui.gui1.list");
		guiDetail = Outside.service(this, "*gus.sys.entityeditor1.gui.gui1.detail");
