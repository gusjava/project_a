package a.entity.gus06.sys.entityeditor1.gui.gui1.list.datafiltered;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(search.startsWith("'"))
			return filterListFullText.t(new Object[] { engine, dataFull, search.substring(1), devId, lockSet, errorSet });
		return filterListName.t(new Object[] { dataFull, search, devId, lockSet, errorSet });
	}
