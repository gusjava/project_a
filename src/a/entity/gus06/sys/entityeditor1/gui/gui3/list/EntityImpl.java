package a.entity.gus06.sys.entityeditor1.gui.gui3.list;
...
public class EntityImpl extends S1 implements Entity, I, V, G {
	...
	{
		buildDataFull = Outside.service(this, "gus.sys.entityeditor1.gui.gui3.list.datafull");
		buildDataFiltered = Outside.service(this, "gus.sys.entityeditor1.gui.gui3.list.datafiltered");
