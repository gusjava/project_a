package a.entity.gus06.sys.expression1.apply.op._block_to_p_with;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(value instanceof String) return new T1(context, (String) value);
	...
	private class T1 implements T
	{
		...
		public T1(Map context, String blockName)
		{
		...
		public Object t(Object obj) throws Exception
		{return new Holder(context,blockName,(String) obj);}
	}
	...
	private class Holder implements P
	{
		...
		public Holder(Map context, String blockName, String argName) throws Exception
		{
			this.context = context;
			this.blockName = blockName;
		...
		private void handle(Object arg) throws Exception
		{
			if(tag1==null) return;
			
			Map args = buildArgMap(arg);
		...
		private Map buildArgMap(Object arg)
		{
