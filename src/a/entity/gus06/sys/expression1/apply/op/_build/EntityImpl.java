...
public class EntityImpl implements Entity, T {
	...
	{
		play1 = Outside.service(this,"factory#gus.sys.play1.manager");
		...
		gridChooser = Outside.service(this,"factory#gus.sys.listchooser2.gui.main");
		tsp_tools1 = Outside.service(this,"factory#gus.sys.ai1.genetics.tsp.tools");
		scheduling1 = Outside.service(this,"factory#gus.sys.scheduling1.manager");
		console1 = Outside.service(this,"factory#gus.swing.textpane.holder.printstreamcomp");
		test1 = Outside.service(this,"factory#gus.test.test1");
		jsf1 = Outside.service(this,"factory#gus.sys.analyzejsf1.analyzer");
		appMem0a = Outside.service(this,"factory#gus.watching.app.memory.gui0a");
		appMem0b = Outside.service(this,"factory#gus.watching.app.memory.gui0b");
		jvmMem0a = Outside.service(this,"factory#gus.watching.jvm.memory.gui0a");
		jvmMem0b = Outside.service(this,"factory#gus.watching.jvm.memory.gui0b");
		jvmMem1 = Outside.service(this,"factory#gus.watching.jvm.memory.gui1");
		txtComparator1 = Outside.service(this,"factory#gus.sys.textcomparator1.gui1");
		treeComparator1 = Outside.service(this,"factory#gus.sys.treecomparator1.gui1");
		treeComparator2 = Outside.service(this,"factory#gus.sys.treecomparator1.gui2");
		dateEditor1 = Outside.service(this,"factory#gus.sys.datepicker1.fr.gui.editor1");
		multiView1 = Outside.service(this,"factory#gus.swing.panel.multiview1");
		webApi = Outside.service(this,"gus06.web.api.provider");
		treeBuilder1 = Outside.service(this,"gus06.swing.tree.build.builder1");
		listTabViewer1 = Outside.service(this,"factory#gus.sys.listtabviewer1.gui.main");
		buttonHoldExecute = Outside.service(this,"factory#gus.swing.button.hold.execute");
		btnChooser = Outside.service(this,"gus06.list.string.chooser.dialog");
		timeTable = Outside.service(this,"factory#gus.appli.entityhistory.gui.timetable");
		countdownLabel = Outside.service(this,"factory#gus.sys.countdown.gui.label");
		...
		dataFirstNameF = Outside.service(this,"factory#gus.data.name.firstname.f");
		dataFirstNameM = Outside.service(this,"factory#gus.data.name.firstname.m");
		dataLastName = Outside.service(this,"factory#gus.data.name.lastname");
		diffHandler = Outside.service(this,"factory#gus.data.diff.handler");
		screenViewer = Outside.service(this,"factory#gus.sys.screen1.viewer.printscreen");
		screenViewer2 = Outside.service(this,"factory#gus.sys.screen1.viewer.printscreen2");
		screenViewer2m = Outside.service(this,"factory#gus.sys.screen1.viewer.printscreen2.withmouse");
		...
		buildForm1 = Outside.service(this,"factory#gus.sys.form1.gui.maingui");
		mysqlTools = Outside.service(this,"factory#gus.sys.mysqltools1.dump");
		...
		guiMapEurope = Outside.service(this,"factory#gus.sys.geomap1.europe.gui1");
		guiMapDepartment = Outside.service(this,"factory#gus.sys.geomap1.fr.departments.gui1");
		guiMapGeneric1 = Outside.service(this,"factory#gus.sys.geomap1.generic.gui1");
		departementsFr = Outside.service(this,"gus06.data.geo.france.department");
		mp3Button = Outside.service(this,"factory#gus.io.inputstream.mp3.play.button");
		wavButton = Outside.service(this,"factory#gus.io.inputstream.wav.play.button");
		shiftPanel = Outside.service(this,"factory#gus.swing.panel.shiftpanel");
		redmineWeb = Outside.service(this,"gus06.web.redmine.urltotext");
		learning1 = Outside.service(this,"gus06.sys.learning1.engine");
		chessGame = Outside.service(this,"factory#gus.sys.chessgame1.gui.game");
		gameOfLife = Outside.service(this,"factory#gus.appli.gameoflife.gui.maingui");
		jwpce1 = Outside.service(this,"gus06.sys.jwpce1.engine");
		appConfig1 = Outside.service(this,"factory#gus.sys.appconfig1.init");
		helpViewer2 = Outside.service(this,"factory#gus.sys.helpviewer2.gui.maingui");
		helpViewer3 = Outside.service(this,"factory#gus.sys.helpviewer3.gui.maingui");
		iconProvider1 = Outside.service(this,"gus06.y.iconprovider1.provider");
		kanjiVG1 = Outside.service(this,"factory#gus.y.kanjivg1.anim.gui1");
		kanjiVG2 = Outside.service(this,"factory#gus.y.kanjivg1.anim.gui2");
		kanjiVG3 = Outside.service(this,"factory#gus.y.kanjivg1.anim.gui3");
		...
		jarBuilder1 = Outside.service(this,"factory#gus.file.jar.builder1");
