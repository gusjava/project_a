package a.entity.gus06.sys.expression1.apply.op._collect2;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		perform = Outside.service(this,"gus06.data.perform.collect2");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(value instanceof Image)		return new T1(value,opMap);
