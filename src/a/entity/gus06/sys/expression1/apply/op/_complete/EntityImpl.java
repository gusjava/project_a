package a.entity.gus06.sys.expression1.apply.op._complete;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		perform = Outside.service(this,"gus06.data.perform.complete");
	}
	...
	private class T2 implements T
	{
		...
		public T2(Object data, Object key, Map opMap)
		{
			this.data = data;
			this.key = key;
			this.opMap = opMap;
		...
		public Object t(Object obj) throws Exception
		{
			...
			return perform.t(new Object[]{data,key,t});
		}
	}
}
