package a.entity.gus06.sys.expression1.apply.op._coord_l_xy;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.data.perform.coord.lentoxy");
	...
	private class T1 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			if(obj instanceof Integer) return perform.t(new Object[]{data,obj});
			if(obj instanceof String) return perform.t(new Object[]{data,obj});
			throw new Exception("Invalid data type: "+obj.getClass().getName());
		}
	}
}
