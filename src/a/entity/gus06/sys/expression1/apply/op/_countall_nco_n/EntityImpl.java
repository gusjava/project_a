package a.entity.gus06.sys.expression1.apply.op._countall_nco_n;
...
public class EntityImpl implements Entity, T {
	...
	{
		builder = Outside.service(this,"gus06.filter.string.build.containsnot_n");
		perform = Outside.service(this,"gus06.data.perform.countall");
	}
