package a.entity.gus06.sys.expression1.apply.op._distance_chebyshev;
...
public class EntityImpl implements Entity, T {
	...
	{
		performDouble = Outside.service(this,"gus06.math.tabdouble.distance.chebyshev");
		performInt = Outside.service(this,"gus06.math.tabint.distance.chebyshev");
	}
