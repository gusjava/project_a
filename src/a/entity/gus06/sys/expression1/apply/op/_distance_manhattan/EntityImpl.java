package a.entity.gus06.sys.expression1.apply.op._distance_manhattan;
...
public class EntityImpl implements Entity, T {
	...
	{
		performDouble = Outside.service(this,"gus06.math.tabdouble.distance.manhattan");
		performInt = Outside.service(this,"gus06.math.tabint.distance.manhattan");
	}
