package a.entity.gus06.sys.expression1.apply.op._double;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.data.perform.double1");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(obj instanceof BufferedImage) return perform.t(obj);
