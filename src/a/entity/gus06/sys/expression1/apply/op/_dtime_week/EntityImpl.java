package a.entity.gus06.sys.expression1.apply.op._dtime_week;
...
public class EntityImpl implements Entity, T {
	...
	public String creationDate() {return "20200521";}
	...
	public EntityImpl() throws Exception
	{
		...
		perform = Outside.service(this,"gus06.time.date.add.weeks");
	}
