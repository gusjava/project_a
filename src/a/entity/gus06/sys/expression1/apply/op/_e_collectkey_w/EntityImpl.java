package a.entity.gus06.sys.expression1.apply.op._e_collectkey_w;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		wrap_fh = Outside.service(this,"gus06.feature.wrap.fh.h");
		
		perform = Outside.service(this,"gus06.data.perform.collectkey");
	}
