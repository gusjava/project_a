package a.entity.gus06.sys.expression1.apply.op._e_completeall2;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		perform = Outside.service(this,"gus06.data.perform.completeall2");
	}
	...
	private class T1 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			...
			return new E1(new Object[]{data,list});
		}
	}
