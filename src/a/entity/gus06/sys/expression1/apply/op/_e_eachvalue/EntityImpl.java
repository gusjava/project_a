package a.entity.gus06.sys.expression1.apply.op._e_eachvalue;
...
public class EntityImpl implements Entity, T {
	...
	{
		builder = Outside.service(this,"gus06.sys.expression1.builder2.p");
		perform = Outside.service(this,"gus06.data.perform.eachvalue");
	}
