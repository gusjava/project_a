package a.entity.gus06.sys.expression1.apply.op._extract_regex_1_l;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		extract = Outside.service(this,"gus06.string.extract.match.last.g1");
	}
	...
	private String extract(String data, Pattern p) throws Exception
	{return (String) extract.t(new Object[]{data,p});}
}
