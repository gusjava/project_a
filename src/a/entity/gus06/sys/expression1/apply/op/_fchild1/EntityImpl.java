package a.entity.gus06.sys.expression1.apply.op._fchild1;
...
public class EntityImpl implements Entity, T {
	...
	public String creationDate() {return "20160929";}
	...
	private Object build(Object obj, String s) throws Exception
	{
		...
		{
			File d = (File) obj;
			return file1(new File(d,s));
		}
		if(obj instanceof File[])
		{
			File[] d1 = (File[]) obj;
			File[] d2 = new File[d1.length];
			for(int i=0;i<d1.length;i++) d2[i] = file1(new File(d1[i],s));
			return d2;
		}
		throw new Exception("Invalid data type: "+obj.getClass().getName());
	}
