package a.entity.gus06.sys.expression1.apply.op._formatnb_percent_dec3;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.string.transform.format.number.percent.decimal3");
	}
