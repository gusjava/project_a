package a.entity.gus06.sys.expression1.apply.op._iso3166_countrymap;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(obj instanceof String) return countryMap((String) obj);
		
		throw new Exception("Invalid data type: "+obj.getClass().getName());
	}
	
	
	private Map countryMap(String ling)
	{
	...
	private String name(String code, Locale lingLocale) 
	{
		...
		return l.getDisplayCountry(lingLocale);
	}
}