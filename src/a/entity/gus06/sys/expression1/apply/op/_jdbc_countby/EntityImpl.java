package a.entity.gus06.sys.expression1.apply.op._jdbc_countby;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.perform.select.countby");
	}
	...
	private class T2 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			...
			return perform.t(new Object[]{cx,tableName,colName});
		}
	}
}