package a.entity.gus06.sys.expression1.apply.op._jdbc_delete_id;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.perform.row.delete2");
	}
	...
	private class E1 implements E
	{
		...
		{
			perform.p(new Object[]{cx,tableName,ids});
		}
	}
}
