package a.entity.gus06.sys.expression1.apply.op._jdbc_find_ct_w;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.perform.select.all.where.as.maplist");
	}
	...
	private class T2 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			List l = (List) perform.t(new Object[]{cx,path,obj});
