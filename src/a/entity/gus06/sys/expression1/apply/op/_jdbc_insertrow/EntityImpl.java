package a.entity.gus06.sys.expression1.apply.op._jdbc_insertrow;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.generic.perform.row.insert");
	}
	...
	private class E1 implements E
	{
		...
		public E1(Connection cx, String tableName, Object data)
		{
			this.cx = cx;
			this.tableName = tableName;
			this.data = data;
		...
		{
			perform.p(new Object[]{cx,tableName,data});
		}
	}
}
