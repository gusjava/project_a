package a.entity.gus06.sys.expression1.apply.op._jdbc_tabletostring_ids;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.perform.select.all.ids1.as.string");
	}
