package a.entity.gus06.sys.expression1.apply.op._jdbc_truncatetable_cascade;
...
public class EntityImpl implements Entity, T {
	...
	{
		truncate = Outside.service(this,"gus06.jdbc.generic.perform.table.truncate.cascade");
	}
