package a.entity.gus06.sys.expression1.apply.op._jdialog_input_asint;
...
public class EntityImpl implements Entity, T {
	...
	public String creationDate() {return "20250425";}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(obj instanceof String)	return toInt(input((String) obj));
		if(obj instanceof Map)		return toInt(input((Map) obj));
		if(obj instanceof String[])	return toInt(input((String[]) obj));
		if(obj instanceof List)		return toInt(input((List) obj));
