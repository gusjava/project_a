package a.entity.gus06.sys.expression1.apply.op._mat_obj;
...
public class EntityImpl implements Entity, T {
	...
	private class T1 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			return buildMatrix(x,y,obj);
		}
	}
	
	
	private Object[][] buildMatrix(int x, int y, Object value) throws Exception
	{
