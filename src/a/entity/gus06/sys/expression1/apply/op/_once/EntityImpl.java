package a.entity.gus06.sys.expression1.apply.op._once;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.app.persister1.once");
	}
	...
	{
		return Boolean.valueOf(perform.f(getClass().getName()+"_"+obj));
	}
}
