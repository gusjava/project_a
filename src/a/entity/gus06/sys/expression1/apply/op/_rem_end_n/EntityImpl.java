package a.entity.gus06.sys.expression1.apply.op._rem_end_n;
...
public class EntityImpl implements Entity, T {
	...
	public String creationDate() {return "20180610";}
	...
	{
		String s1_ = normalize(s1);
		String s2_ = normalize(s2);
		
		int n = s2.length();
		while(s1_.endsWith(s2_))
		{
			s1_ = s1_.substring(0,s1_.length()-n);
			s1 = s1.substring(0,s1.length()-n);
		}
		return s1;
	}
