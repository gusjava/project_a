package a.entity.gus06.sys.expression1.apply.op._searchfiles_filtername0_st_i;
...
public class EntityImpl implements Entity, T {
	...
	public String creationDate() {return "20210106";}
	...
	{
		builder = Outside.service(this,"gus06.filter.string.build.startswith_i");
		perform = Outside.service(this,"gus06.dir.perform.searchfiles.filtername0");
