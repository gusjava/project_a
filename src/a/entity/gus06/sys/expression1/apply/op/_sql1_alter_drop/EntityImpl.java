package a.entity.gus06.sys.expression1.apply.op._sql1_alter_drop;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.sql.table.alter.drop");
	...
	private class T1 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{return perform.t(new String[]{path,(String) obj});}
	}
}