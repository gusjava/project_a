package a.entity.gus06.sys.expression1.apply.op._sql1_alter_modify;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.sql.table.alter.modify");
	...
	private class T2 implements T
	{
		...
		public Object t(Object obj) throws Exception
		{
			...
			return perform.t(new String[]{path,fieldName,fieldType});
		}
	}
}