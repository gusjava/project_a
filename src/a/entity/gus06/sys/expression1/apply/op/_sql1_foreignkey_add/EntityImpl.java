package a.entity.gus06.sys.expression1.apply.op._sql1_foreignkey_add;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.jdbc.mysql.sql.foreignkey.add");
	...
	private Object[] mapToArray(Map map) throws Exception
	{
		...
		String fkName0 = "fk_"+path+"_"+column1;
		String fkName = get(map,"name",fkName0);
		
		return new Object[]{path,fkName,column1,refTable,column2};
	}
