package a.entity.gus06.sys.expression1.apply.op._tolines;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		split = Outside.service(this,"gus06.string.split.lines1.list");
		split2 = Outside.service(this,"gus06.string.split.lines1.list2");
	}
