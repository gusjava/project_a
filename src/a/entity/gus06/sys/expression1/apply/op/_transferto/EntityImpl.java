package a.entity.gus06.sys.expression1.apply.op._transferto;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.data.perform.transferto");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(obj instanceof Socket) return new T1(obj);
