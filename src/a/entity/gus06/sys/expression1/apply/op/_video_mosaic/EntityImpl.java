package a.entity.gus06.sys.expression1.apply.op._video_mosaic;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.file.video.generic.mosaic");
	}
	...
	private class T1 implements T
	{
		...
		{
			int nb = toInt(obj);
			return perform.t(new Object[]{file,null,nb});
		}
	}
