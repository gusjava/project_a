package a.entity.gus06.sys.expression1.builder2.f.n;
...
public class EntityImpl implements Entity, T {
	...
	{
		mapToF = Outside.service(this,"gus06.map.contains.key.maptof.n");
		colToF = Outside.service(this,"gus06.collection.contains.coltof.n");
	}
