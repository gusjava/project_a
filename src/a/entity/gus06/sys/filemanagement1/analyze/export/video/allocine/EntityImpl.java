package a.entity.gus06.sys.filemanagement1.analyze.export.video.allocine;
...
public class EntityImpl implements Entity, P {
	...
	public static final String CODE_ALLOCINE = "allocine.code";
	...
	public void p(Object obj) throws Exception
	{
		...
		for(int i=0;i<nb;i++)
		{
			...
			if(prop!=null && prop.containsKey(CODE_ALLOCINE))
			{
