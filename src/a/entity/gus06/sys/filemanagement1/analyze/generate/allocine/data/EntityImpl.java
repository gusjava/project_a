package a.entity.gus06.sys.filemanagement1.analyze.generate.allocine.data;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception
	{
		...
		if(ff1!=null)
		{
			...
			if(ff2!=null)
			{
				p.println("GENRE -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"genre_code","genre"});
			
				p.println("MOVIE_TYPE -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"movietype_code","movietype"});
				
				p.println("ACTOR -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"actor_code","actors"});
				
				p.println("DIRECTOR -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"director_code","directors"});
				
				p.println("NATIONALITY -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"nationality_code","nationality"});
				
				p.println("PRODUCTION_YEAR -> CODE");
				generateSeq.p(new Object[]{dirGen,ff2,codes,"productionyear_code","productionyear"});
				
				p.println("RELEASE_DATE -> CODE");
				generateFull.p(new Object[]{dirGen,ff2,codes,"releasedate_code","releasedate"});
				
				p.println("USER_RATING -> CODE");
				generateFull.p(new Object[]{dirGen,ff2,codes,"ratingU_code","userrating"});
				
				p.println("PRESS_RATING -> CODE");
				generateFull.p(new Object[]{dirGen,ff2,codes,"ratingP_code","pressrating"});
				
				p.println("TITLE -> CODE");
				generateFull.p(new Object[]{dirGen,ff2,codes,"title_code","title"});
			}
		}
