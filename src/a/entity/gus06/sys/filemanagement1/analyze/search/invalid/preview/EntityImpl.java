package a.entity.gus06.sys.filemanagement1.analyze.search.invalid.preview;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		checkInvalid = Outside.service(this,"gus06.sys.filemanagement1.tool.preview.check.invalid.file");
	}
	...
	private class Handler implements P
	{
		...
		public void p(Object obj) throws Exception
		{
			...
			{
				File previewFile = (File) engine.r("previewFile:"+md5);
				try{checkInvalid.p(previewFile);}
				catch(Exception e)
				{
