package a.entity.gus06.sys.filemanagement1.analyze.search.invalid.prop;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		checkInvalid = Outside.service(this,"gus06.sys.filemanagement1.tool.prop.check.invalid.file");
	}
	...
	private class Handler implements P
	{
		...
		public void p(Object obj) throws Exception
		{
			...
			{
				File propFile = (File) engine.r("propFile:"+md5);
				try{checkInvalid.p(propFile);}
				catch(Exception e)
				{
