package a.entity.gus06.sys.filemanagement1.analyze.search.missing.allocine.md5code;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		findACode = Outside.service(this,"gus06.sys.filemanagement1.tool.allocine.md5.find.file");
	}
		...
		public void p(Object obj) throws Exception
		{
			...
			if(scannable.f(new Object[]{engine,md5,size}))
			{
				...
				if(prop!=null && prop.containsKey(KEY_CODE))
				{
					...
					File aFile = (File) findACode.t(new Object[]{engine,code});
					if(!aFile.exists())
					{
