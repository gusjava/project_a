package a.entity.gus06.sys.filemanagement1.analyze.search.missing.allocine.poster;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		findAPoster = Outside.service(this,"gus06.sys.filemanagement1.tool.allocine.poster.find.file");
	}
	...
	private class Handler implements P
	{
		...
		public void p(Object obj) throws Exception
		{
			...
			if(scannable.f(new Object[]{engine,md5,size}))
			{
				...
				if(prop!=null && prop.containsKey(KEY_CODE))
				{
					String code = (String) prop.get(KEY_CODE);
					File aFile = (File) findAPoster.t(new Object[]{engine,code});
					if(!aFile.exists())
					{
						p.println(md5+"\t"+rootName+"@"+location+"\\"+fileName+" ("+size+")");
						p.println("allocine.code="+code);
						foundNb++;
					}
				}
			}
