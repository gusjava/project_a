package a.entity.gus06.sys.filemanagement1.gui.detailpanel.dir.doubloons.md5viewer1;
...
public class EntityImpl implements Entity, I, P, ActionListener {
	...
	private void updateGui()
	{
		try
		{
			...
			String[] extName0 = (String[]) getName0Ext.t(path);
			String name0 = extName0[0];
			String ext = extName0[1];
			
			G image = (G)((R)engine).r("preview_g:"+md5);
			
			String name = name0+"."+ext;
			Icon icon = (Icon) findIcon.t(ext);
