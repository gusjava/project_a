package a.entity.gus06.sys.filemanagement1.gui.detailpanel.dir.doubloons.results;
...
public class EntityImpl implements Entity, I, P {
	...
	{
		newViewer = Outside.service(this,"factory#gus06.sys.filemanagement1.gui.detailpanel.dir.doubloons.md5viewer1");
	...
	private void updateGui()
	{
		try
		{
			...
			for(int i=0;i<keys.size();i++)
			{
				...
				((P)viewer).p(new Object[]{engine, selected, m});
