package a.entity.gus06.sys.filemanagement1.gui.detailpanel.file.infos;
...
public class EntityImpl extends S1 implements Entity, I, P {
	...
	private JButton button_resetInfos;
	...
	private void refresh()
	{
		try
		{
			...
			infoFile = (File) ((R) engine).r("infoFile:"+md5);
			propEditor.p(infoFile);
			
			button_resetInfos.setEnabled(prop!=null);
		}
		catch(Exception e)
	...
	private void resetInfos()
	{
		try
		{
			...
			deleteFile.p(infoFile);
			propEditor.p(null);
			updated();
		}
		catch(Exception e)
		{Outside.err(this,"resetInfos()",e);}
	}
