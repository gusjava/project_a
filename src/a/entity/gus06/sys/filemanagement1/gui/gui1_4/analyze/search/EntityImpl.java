package a.entity.gus06.sys.filemanagement1.gui.gui1_4.analyze.search;
...
public class EntityImpl implements Entity, I, P {
	...
	public EntityImpl() throws Exception
	{
		...
		comboHolder = Outside.service(this,"*gus06.sys.filemanagement1.gui.gui1_4.analyze.search.combo");
		
		P factory = obj->build((PrintStream) obj);
		
		factoryGui.v("buttonText","Search");
