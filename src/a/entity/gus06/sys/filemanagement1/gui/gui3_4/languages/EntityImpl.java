package a.entity.gus06.sys.filemanagement1.gui.gui3_4.languages;
...
public class EntityImpl implements Entity, I, P {
	...
	public static final String FIELDNAME = "language_md5";
	public static final String PROPNAME = "ebook.language";
