package a.entity.gus06.sys.filemanagement1.gui.gui4.tab;
...
public class EntityImpl implements Entity, ActionListener, I, P, V {
	...
	public static final String ENGINE_KEY = "dirGenerated_pdf";

	private Service getName0;
	private Service readList;
	private Service listViewer;
	private Service pdfViewer;
	...
	public EntityImpl() throws Exception
	{
		...
		pdfViewer = Outside.service(this,"*gus06.sys.filemanagement1.gui.pdfs.pdflist.viewer");
		...
		split.setRightComponent((JComponent) pdfViewer.i());
	...
	private void selected()
	{
		try
		{
			...
			pdfViewer.p(new Object[]{engine,md5List});
		}
		catch(Exception e)
