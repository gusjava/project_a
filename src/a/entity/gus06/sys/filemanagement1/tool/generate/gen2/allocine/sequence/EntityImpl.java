package a.entity.gus06.sys.filemanagement1.tool.generate.gen2.allocine.sequence;
...
public class EntityImpl implements Entity, P {
	...
	private void handleProp(Map prop, String key, String code, Map map) throws Exception
	{
		...
		String[] sequence = (String[]) splitSequence.t(value);
		for(String s : sequence) add(map,s,code);
	}
