...
public class EntityImpl extends S1 implements Entity, I, G, R, V {
	...
	{
		url = (URL) Outside.resource(this, "inside#url.svg/departments_fr.svg");
	...
	public Object r(String key) throws Exception
	{
		...
		if(key.equals("currentCode")) return panel.getHoverCode();
		if(key.equals("currentName")) return panel.getHoverName();
		...
		if(key.equals("outsideColor")) return panel.getOutsideColor();
	...
	public void v(String key, Object obj) throws Exception
	{
		...
		if(key.equals("outsideColor"))
		{
			panel.setOutsideColor((Color) obj);
			return;
		}
