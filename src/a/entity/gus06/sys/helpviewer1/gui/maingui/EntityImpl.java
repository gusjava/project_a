package a.entity.gus06.sys.helpviewer1.gui.maingui;
...
public class EntityImpl implements Entity, ActionListener, I, P, V {
	...
	{
		tree = Outside.service(this,"*gus06.sys.helpviewer1.gui.tree");
		panel = Outside.service(this,"*gus06.sys.helpviewer1.gui.panel");
