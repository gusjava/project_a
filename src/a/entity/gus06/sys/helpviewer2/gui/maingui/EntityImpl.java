package a.entity.gus06.sys.helpviewer2.gui.maingui;
...
public class EntityImpl implements Entity, ActionListener, I, P, V {
	...
	{
		tree = Outside.service(this,"*gus06.sys.helpviewer2.gui.tree");
		panel = Outside.service(this,"*gus06.sys.helpviewer2.gui.panel");
