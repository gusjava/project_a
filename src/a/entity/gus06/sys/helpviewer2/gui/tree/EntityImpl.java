package a.entity.gus06.sys.helpviewer2.gui.tree;
...
public class EntityImpl extends S1 implements Entity, V, R, I, P, G, TreeSelectionListener {
	...
	public EntityImpl() throws Exception
	{
		...
		renderer = Outside.service(this,"gus06.sys.helpviewer2.gui.tree.renderer");
	...
	public Object r(String key) throws Exception
	{
		...
		if(key.equals("keys")) return new String[]{"ip","map","tree","model","content"};
