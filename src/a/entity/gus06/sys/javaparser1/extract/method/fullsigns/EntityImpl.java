package a.entity.gus06.sys.javaparser1.extract.method.fullsigns;
...
public class EntityImpl implements Entity, T {
	...
	private Service extractFullName;
	private Service buildSign;

	public EntityImpl() throws Exception
	{
		buildCU = Outside.service(this,"gus06.sys.javaparser1.tool.build.compilationunit");
		extractFullName = Outside.service(this,"gus06.sys.javaparser1.extract.classfullname");
	...
	public Object t(Object obj) throws Exception
	{
		...
		String fullName = (String) extractFullName.t(cu);
		
		List list = new ArrayList();
		Visitor1 v = new Visitor1(fullName);
		v.visit(cu, list);
		return list;
	}
	...
	private class Visitor1 extends VoidVisitorAdapter<List>
	{
		...
		public Visitor1(String fullName)
		{this.fullName = fullName;}
		
		public void visit(MethodDeclaration md, List list)
		{
			super.visit(md, list);
			list.add(fullName+"#"+buildSign(md));
		}
	}
