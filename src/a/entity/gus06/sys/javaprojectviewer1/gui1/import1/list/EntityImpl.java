package a.entity.gus06.sys.javaprojectviewer1.gui1.import1.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	public static final String TITLE = "Imports";
	...
	{
		control = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui1.import1.list.control");
		rendering = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.import1.list.rendering");
		updater = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.import1.list.updater");
