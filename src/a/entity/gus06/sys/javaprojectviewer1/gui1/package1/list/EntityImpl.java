package a.entity.gus06.sys.javaprojectviewer1.gui1.package1.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	public static final String TITLE = "Packages";
	...
	{
		control = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui1.package1.list.control");
		rendering = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.package1.list.rendering");
		updater = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.package1.list.updater");
