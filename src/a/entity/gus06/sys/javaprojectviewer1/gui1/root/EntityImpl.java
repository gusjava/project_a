package a.entity.gus06.sys.javaprojectviewer1.gui1.root;
...
public class EntityImpl implements Entity, ActionListener, I, P {
	...
	{
		list = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui1.root.list");
		table = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui1.package1");
