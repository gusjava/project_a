package a.entity.gus06.sys.javaprojectviewer1.gui1.root.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	public static final String TITLE = "Roots";
	...
	{
		control = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui1.root.list.control");
		rendering = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.root.list.rendering");
		updater = Outside.service(this,"gus06.sys.javaprojectviewer1.gui1.root.list.updater");
