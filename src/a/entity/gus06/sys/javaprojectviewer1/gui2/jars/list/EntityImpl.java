package a.entity.gus06.sys.javaprojectviewer1.gui2.jars.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	public static final String TITLE = "Jars";
	...
	{
		control = Outside.service(this,"*gus06.sys.javaprojectviewer1.gui2.jars.list.control");
		rendering = Outside.service(this,"gus06.sys.javaprojectviewer1.gui2.jars.list.rendering");
		updater = Outside.service(this,"gus06.sys.javaprojectviewer1.gui2.jars.list.updater");
	...
	private synchronized void changeSelection()
	{
		...
		selected = tab!=null ? (File) tab[0] : null;
		selectionChanged();
	}
