package a.entity.gus06.sys.mailclient1.tool.show.message.viewer.text;
...
public class EntityImpl implements Entity, I, P {
	...
	{
		messageToText = Outside.service(this,"gus06.mail.retrieve.message.content.text");
	...
	public void p(Object obj) throws Exception
	{
		...
		{
			message = (Message) obj;
			text = (String) messageToText.t(message);
