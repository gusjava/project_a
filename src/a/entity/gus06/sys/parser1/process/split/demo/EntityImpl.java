package a.entity.gus06.sys.parser1.process.split.demo;
...
public class EntityImpl implements Entity, ActionListener, I, G {
	...
	{
		engine = Outside.service(this,"gus06.sys.parser1.process.split");
	...
	public Object g() throws Exception
	{
		...
		T splitter = (T) engine.t(delim);
		return splitter.t(text);
	}
