package a.entity.gus06.sys.quickreplace.holder.build;
...
public class EntityImpl implements Entity, T {
	...
	{
		perform = Outside.service(this,"gus06.sys.quickreplace.perform");
	...
	private class Holder extends Holder0 implements P, I
	{
		...
		// Ancienne m�thode insert qui banissait le \n (raison ?)
