package a.entity.gus06.sys.runtask2.input.file.chooser;
...
public class EntityImpl implements Entity, G {
	...
	public EntityImpl() throws Exception
	{
		...
		annexe = Outside.service(this,"*gus06.sys.runtask2.input.file.chooser.annexe");
		manager = Outside.service(this,"gus06.sys.runtask2.input.file.manager");
