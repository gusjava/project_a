package a.entity.gus06.sys.script1.analyze1;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildTagText = Outside.service(this,"gus06.sys.script1.analyze1.buildtag.text");
		buildTagElement = Outside.service(this,"gus06.sys.script1.analyze1.buildtag.element");
	}
