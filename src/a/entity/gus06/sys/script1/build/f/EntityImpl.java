package a.entity.gus06.sys.script1.build.f;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(o.length==2) return new F1(o[0],(Map) o[1],null);
		if(o.length==3) return new F1(o[0],(Map) o[1],(Map) o[2]);
	...
	private class F1 implements F
	{
		...
		public F1(Object src, Map opMap, Map data)
		{
			this.src = src;
			this.opMap = opMap;
			this.data = data;
		...
		public boolean f(Object obj) throws Exception
		{
			...
			Boolean r = (Boolean) returnSet.iterator().next();
