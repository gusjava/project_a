package a.entity.gus06.sys.script1.build.g;
...
public class EntityImpl implements Entity, T {
	...
	private class G1 implements G
	{
		...
		public G1(Object src, Map opMap, Map data) throws Exception
		{
			this.src = src;
			this.opMap = opMap;
			this.data = data;
			
			if(src==null) throw new Exception("src not found");
			if(opMap==null) throw new Exception("opMap not found");
		}
