package a.entity.gus06.sys.script1.build.r;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(o.length==2) return new R1(o[0],(Map) o[1],null);
		if(o.length==3) return new R1(o[0],(Map) o[1],(Map) o[2]);
	...
	private class R1 implements R
	{
		...
		public R1(Object src, Map opMap, Map data)
		{
			this.src = src;
			this.opMap = opMap;
			this.data = data;
