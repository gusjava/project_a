package a.entity.gus06.sys.script1.executor.type.el.r.each.set;
...
public class EntityImpl implements Entity, P {
	...
	public void p(Object obj) throws Exception
	{
		...
		List struct = sortStruct((Collection) main, sort);
	...
	private List sortStruct(Collection struct, Object sort)
	{
		List l = new ArrayList(struct);
