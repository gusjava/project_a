package a.entity.gus06.sys.script1.executor.type.el.r.for1;
...
public class EntityImpl implements Entity, T {
	...
	{
		buildRange = Outside.service(this,"gus06.sys.script1.executor.type.el.r.for1.range");
		...
		public void p(Object obj) throws Exception
		{
			...
			if(range!=null)
			{
				...
				for(int i=start;!endFound;i+=incr)
				{
					...
					m.put("times",Integer.valueOf(times));
					m.put("start",Integer.valueOf(start));
					m.put("end",Integer.valueOf(end));
					m.put("incr",Integer.valueOf(incr));
					m.put("first",Boolean.valueOf(i==start));
					m.put("last",Boolean.valueOf(i==end));
