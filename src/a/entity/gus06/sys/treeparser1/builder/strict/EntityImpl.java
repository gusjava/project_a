package a.entity.gus06.sys.treeparser1.builder.strict;
...
public class EntityImpl implements Entity, P {
	...
	{
		if(data.startsWith("@")) throw new Exception("Invalid data: starts with @");
		if(data.contains("\n@")) throw new Exception("Invalid data: contains a line starting with @");
