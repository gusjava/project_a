package a.entity.gus06.sys.webserver1.web2.zdyn.e.format.formatter2;
...
public class EntityImpl implements Entity, T {
	...
	{
		compute = Outside.service(this,"gus06.sys.webserver1.web2.zdyn.e.format.formatter2.compute");
		p = Pattern.compile("\\{[^\\{\\}:]+:[^\\{\\}]+\\}");
	}
