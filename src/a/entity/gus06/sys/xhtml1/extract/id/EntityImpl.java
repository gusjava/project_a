package a.entity.gus06.sys.xhtml1.extract.id;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		extractAll = Outside.service(this,"gus06.string.extract.extract1.find.s.a");
	}
	
	public Object t(Object obj) throws Exception
	{
		String text = toText(obj);
		return extractAll.t(new String[]{text, RULE_ID});
	}
