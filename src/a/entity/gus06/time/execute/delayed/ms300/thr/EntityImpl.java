package a.entity.gus06.time.execute.delayed.ms300.thr;
...
public class EntityImpl implements Entity, T {
	...
	private void execute(final E execute)
	{
		Thread t = new Thread(()->execute_(execute),"THREAD_"+getClass().getName());
		t.start();
	}
	
	private void execute_(E execute)
	{
		try{execute.e();}
		catch(Exception e)
		{Outside.err(this,"execute_(E)",e);}
	}
}
