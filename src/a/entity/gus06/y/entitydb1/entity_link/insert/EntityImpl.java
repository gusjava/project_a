package a.entity.gus06.y.entitydb1.entity_link.insert;
	...
	public void p(Object obj) throws Exception
	{
		...
		try
		{
			String sql = "INSERT INTO " + TABLE_NAME + " ("
			 + COL_ENTITY_NAME + "," + COL_LINK + ") VALUES (?,?) ";
			executeUpdate(cx, sql, entityName, link);
		}
		catch (SQLException e)
		{throw new Exception("Failed add link [" + link + "] to entity [" + entityName + "]", e);}
	}
