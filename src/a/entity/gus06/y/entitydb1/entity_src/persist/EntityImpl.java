package a.entity.gus06.y.entitydb1.entity_src.persist;
...
public class EntityImpl implements Entity, P {
	...
	{
		count = Outside.service(this,"gus06.y.entitydb1.entity_src.count");
		insert = Outside.service(this,"gus06.y.entitydb1.entity_src.insert");
		update = Outside.service(this,"gus06.y.entitydb1.entity_src.update");
	}
