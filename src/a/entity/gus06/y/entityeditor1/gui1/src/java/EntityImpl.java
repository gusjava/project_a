package a.entity.gus06.y.entityeditor1.gui1.src.java;
...
public class EntityImpl implements Entity, P, I, R, DocumentListener {
	...
	public EntityImpl() throws Exception
	{
		...
		buildScroll = Outside.service(this,"gus06.y.swing1.textarea.buildscrollpane.linenb");
		buildHighSup = Outside.service(this,"gus06.y.swinghigh1.support");
		buildHighScroll = Outside.service(this,"gus06.y.swinghigh1.scrollpaint");
		...
		buildCaretPos = Outside.service(this,"gus06.x.swing.textcomp.build.caretpositionlabel");
		...
		restoreSrc = Outside.service(this,"gus06.y.entitydb1.entity_src.find");
		clearSrc = Outside.service(this,"gus06.y.entitydb1.entity_src.delete");
		...
		hiddenComp = (JComponent) buildHiddenLabel.t(area);
