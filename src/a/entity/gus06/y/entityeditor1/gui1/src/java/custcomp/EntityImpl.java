package a.entity.gus06.y.entityeditor1.gui1.src.java.custcomp;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		paintCaretLine = Outside.service(this,"gus06.y.swing1.textarea1.p.paint.caretline");
		slashComment = Outside.service(this,"gus06.swing.textcomp.cust.action.ctrl_shift_slash.comment");
		autoEdit1 = Outside.service(this,"gus06.y.swing1.textcomp.cust.autoedit1");
		custComp1 = Outside.service(this,"gus06.y.swingactions1.custcomp1");
		addJavaImport1 = Outside.service(this,"gus06.swing.textcomp.cust.action.f2.java.autoimport");
		autocomplete1 = Outside.service(this,"gus06.y.entityeditor1.gui1.src.java.f1.autocomplete");
	}
