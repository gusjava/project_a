package a.entity.gus06.y.entityeditor1.gui1.src.java.f1.autocomplete;
...
public class EntityImpl implements Entity, P {
	...
	public static final String DEFAULT_KEY = "f1";
	...
	{
		perform = Outside.service(this,"gus06.y.entityeditor1.gui1.src.java.f1.autocomplete.perform");
