package a.entity.gus06.y.entityeditor1.gui3.infos.downlinks;
...
public class EntityImpl implements Entity, P, I, MouseListener, ActionListener {
	...
	{
		findLinks = Outside.service(this, "gus.y.entitydb1.entity_link.find2.sorted");
	...
	{
		if (e.getButton()==MouseEvent.BUTTON3) selectEntity();
	}
