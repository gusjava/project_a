package a.entity.gus06.y.entitysys1.compile.entity;
...
public class EntityImpl implements Entity, P, F {
	...
	public EntityImpl() throws Exception
	{
		...
		findJavac = Outside.service(this, "gus.x.jdkdir.find.javac");
	...
	public boolean f(Object obj) throws Exception
	{
		...
		File jdkDir = (File) ((R) engine).r("jdkDir");
		...
		for (File entityClassFile : entityClassFiles) entityClassFile.delete();
		...
		File javacFile = (File) findJavac.t(jdkDir);
