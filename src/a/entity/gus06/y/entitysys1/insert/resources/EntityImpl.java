package a.entity.gus06.y.entitysys1.insert.resources;
...
public class EntityImpl implements Entity, P {
	...
	{
		insert = Outside.service(this, "gus.y.entitydb1.entity_resource.insert");
	}
	...
	public void p(Object obj) throws Exception
	{
		...
		Set resourceInfos = (Set) data.get(KEY_RESOURCES);

		Iterator it = resourceInfos.iterator();
