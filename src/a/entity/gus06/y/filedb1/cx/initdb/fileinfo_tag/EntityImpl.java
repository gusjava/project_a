package a.entity.gus06.y.filedb1.cx.initdb.fileinfo_tag;
...
public class EntityImpl implements Entity, P {
    ...
    public static final String TABLE_NAME = "fileinfo_tag";
    ...
    public static final String DEF_TAG = "VARCHAR(100) NOT NULL";
