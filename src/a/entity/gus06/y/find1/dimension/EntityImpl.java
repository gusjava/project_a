package a.entity.gus06.y.find1.dimension;
...
public class EntityImpl implements Entity, T {
	...
	{
		stringToDimension = Outside.service(this, "gus.y.convert1.stringtodimension");
	}
	...
	public Object t(Object obj) throws Exception
	{
		...
		if (obj instanceof List)
			return listToDim((List) obj);
		if (obj instanceof String)
			return stringToDimension.t(obj);
