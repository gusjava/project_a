package a.entity.gus06.y.h2viewer1.gui.list.rendering;
...
public class EntityImpl implements Entity, P {
	...
	public static final Color COLOR_H2 = new Color(204,102,0);
	...
	private class TableCellRenderer0 extends JLabel implements TableCellRenderer
	{
		...
		{
			String tableName = (String) table.getValueAt(x,0);
			Long count = (Long) table.getValueAt(x,1);
			
			setForeground(foreground(tableName, count));
	...
	private Color foreground(String tableName, Long count)
	{
		if(isH2Table(tableName)) return COLOR_H2;
	...
	private boolean isH2Table(String tableName)
	{
		return tableName.startsWith("h2_");//TODO � ajuster
	}
}