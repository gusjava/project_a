package a.entity.gus06.y.sqliteviewer1.gui.list.rendering;
...
public class EntityImpl implements Entity, P {
	...
	public static final Color COLOR_SQLITE = new Color(204,102,0);
	...
	{
		if(isSqliteTable(tableName)) return COLOR_SQLITE;
	...
	private boolean isSqliteTable(String tableName)
	{
