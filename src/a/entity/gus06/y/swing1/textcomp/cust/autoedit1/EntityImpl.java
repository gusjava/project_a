package a.entity.gus06.y.swing1.textcomp.cust.autoedit1;
...
public class EntityImpl implements Entity, P {
	...
	{
		performEnter = Outside.service(this, "gus.y.swing1.textcomp.cust.autoedit1.enter.perform");
		performTab = Outside.service(this, "gus.y.swing1.textcomp.cust.autoedit1.tab.perform");
		performTabInv = Outside.service(this, "gus.y.swing1.textcomp.cust.autoedit1.tab_inv.perform");
	}
		...
		public void keyPressed(KeyEvent e)
		{
			...
			else
			{
				switch (code)
				{
					...
					perform(performEnter, comp);
					break;
					
					case KeyEvent.VK_TAB:
					perform(performTab, comp);
					break;
				}
			}
		}
